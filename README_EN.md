...
> **📦 CLI install**: `npm i -g chainlesschain@0.166.14` (current fully gated build and npm `latest`; aliases `cc` / `clc` / `clchain`).
...
## 2026-08-31 Current mainline — **v5.0.3.135 / CLI 0.166.14 production recommendation and npm latest / Agent SDK 0.2.7 (TS/Python) / Agent Protocol 0.1.7 / Session Core 0.3.8 / PDH 0.4.59**

> **Release status:** `chainlesschain@0.166.14` is the fully gated production recommendation and npm `latest`. Immutable tag `v-npm-0-166-14` resolves to exact commit [`ee88125256`](https://github.com/chainlesschain/chainlesschain/commit/ee88125256b5de8281be0a8e57157811bb80c105). That SHA passed the [three-OS CLI CI](https://github.com/chainlesschain/chainlesschain/actions/runs/33322714911), [CLI Strict Sandbox](https://github.com/chainlesschain/chainlesschain/actions/runs/33322714747), and [npm Trusted Publishing, provenance, and public readback](https://github.com/chainlesschain/chainlesschain/actions/runs/33322714744).
>
> **Agent Platform 0.166.14:** on top of `0.166.9` durable Graph, real UI replay, and exact Codex compatibility gates, this release publishes the canonical Context/Memory Kernel, durable rollout stores, and converged Hooks v2. `0.166.13` closes P0 renderer-IPC, default-sandbox/approval, and process-audit bypasses; `0.166.14` restores ordinary Windows startup without Docker while keeping explicitly requested isolation fail-closed.
>
...
>
> **IDE release:** Open VSX `0.37.76` is public with more than **33,000** downloads, and JetBrains Marketplace `0.4.106` is approved, listed, and publicly readable. Their immutable tags share exact commit [`0f0b9f7c8c`](https://github.com/chainlesschain/chainlesschain/commit/0f0b9f7c8c6c59556fdf29bd8c4c15cd704b0653); the [VS Code release gate](https://github.com/chainlesschain/chainlesschain/actions/runs/33327049581) and [JetBrains release gate](https://github.com/chainlesschain/chainlesschain/actions/runs/33327049302) both passed. Microsoft VS Code Marketplace still does not expose the extension.
>
> **Release and source boundary:** current GitHub `main` is [`0761d4d297`](https://github.com/chainlesschain/chainlesschain/commit/0761d4d2976c0ff7ccafc469fe877e685812c456), later than the `0.166.14` release SHA. Mainline adds Team worktree terminal evidence, canonical Graph trace persistence, and hermetic-home, credential-isolated, Windows-ACL-preflighted formal Graph collaboration quality evaluation with a reduced tool surface, timeout floor, and refreshed producer digest. These remain source/gate changes and do not inherit `0.166.14` artifact identity. GraphRun unifies run identity, authority, budget, and revision only; Task Graph, dynamic Agent Tree, and Artifact/Trace evidence remain separate projections.
>
> **Release-chain closure:** `0.166.14@ee88125256` has a closed chain of tag identity, Linux/Windows/macOS CLI CI and Strict Sandbox matrices, immutable artifacts, Trusted Publishing, signed provenance, and independent registry readback. The [Record Replay UI Journey](https://github.com/chainlesschain/chainlesschain/actions/runs/33330041069) and [Desktop Signed Skill Qualification](https://github.com/chainlesschain/chainlesschain/actions/runs/33322714737) also passed at that exact SHA. Earlier long-running gates remain evidence only for their own versions. PDH remains `0.4.59` with optional native SQLite and a `sql.js` fallback.
>
> See the [Agent Platform 0.166.14 guide](docs-site/docs/chainlesschain/agent-platform-release.md), [Agent SDK guide](docs-site/docs/chainlesschain/agent-sdk.md), [GraphRun observation and evaluation guide](docs-site/docs/chainlesschain/cli-team-graph.md), [current CLI Runtime](docs-site/docs/chainlesschain/cli-runtime-current.md), [Graph Kernel design](docs/design/modules/105_Graph_Kernel设计.md), [Agent Platform release-boundary design](docs/design/modules/110-agent-platform-release-boundaries.md), and the [changelog](CHANGELOG.md).
