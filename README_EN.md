...
>
> **CLI 0.163.0:** carries the complete `0.162.200` canonical-session authority, pinned npm-backed MCP execution capsules, native update recovery, and portable reliability gates, then repairs macOS `node-pty` helper permissions and validates all six native targets on matching architectures. It starts the second command-lifecycle observation cycle while retaining all 25 compatibility aliases.
>
