...
## 2026-08-12 Current mainline — **v5.0.3.135 / CLI 0.163.6 / PDH 0.4.57 / Open VSX 0.37.50 / JetBrains 0.4.86**
...
>
> **Automation control plane:** Open VSX `0.37.50` and JetBrains `0.4.86` add an Automation Center that reads CLI-owned versioned projections, displays scope, preflight, and history, and routes run-now, failed-run retry, pause/resume, disable/delete, plus revision-CAS Routine creation and edits for cron/once/webhook/GitHub triggers. The IDE never writes authoritative storage directly. External-SaaS outcome-unknown adjudication, complete mixed-version migration/rollback, scheduler disk-fault closure, and the three-OS long-soak matrix remain open.
>
...
>
> **IDE mainline:** Open VSX `0.37.50` and JetBrains Marketplace `0.4.86` are public; the Open VSX listing had passed **24,000 downloads** by 2026-08-12. Both immutable tags resolve to [`074bc47129`](https://github.com/chainlesschain/chainlesschain/commit/074bc471297b4ae0f02445b9bdb30d4dd11d5536). The [Open VSX release gate](https://github.com/chainlesschain/chainlesschain/actions/runs/31589542152) and [JetBrains release gate](https://github.com/chainlesschain/chainlesschain/actions/runs/31589547677) completed real three-OS hosts, artifact checks, publication, and listing readback. Microsoft VS Code Marketplace and JetBrains author signing remain open.
>
