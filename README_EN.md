...
## 2026-04-18 Update — CLI 0.129.0 · V2 Batch 6 · 13 Runtime Managers

Later the same day that 0.106.0 (V2 batch 5) shipped, we pushed one more round: **all 13 runtime-manager modules** now carry the V2 canonical surface. CLI bumps `0.106.0 → 0.129.0` (tag `v5.0.2.10`).
...
**npm**: `npm i -g chainlesschain@0.129.0` (aliases `cc` / `clc` / `clchain`)
