...
**Current Version**: v5.0.2.49 (Evolution Edition — 139 Desktop Skills + 28 Android Skills + 109 CLI Commands + 7600+ Tests)

**Version hierarchy** (independent tracks — do not attempt to unify):
- Product line: `v5.0.2.49` (marketing / release notes / docs — single source: `package.json.productVersion`)
- CLI npm: `chainlesschain@0.156.6` (`packages/cli/package.json`)
