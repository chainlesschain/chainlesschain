...
**Current Version**: v5.0.2.10 (Evolution Edition — 139 Desktop Skills + 28 Android Skills + 65 CLI Commands + 5940+ Tests)
...
| CLI | `packages/cli/` | npm CLI (~2MB, 64 commands, Commander) |
