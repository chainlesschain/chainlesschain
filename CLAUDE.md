...
# npm users: no build needed (bundled via prepublishOnly → src/assets/web-panel/)
# Source users: npm run build:web-panel (once, or after updating web-panel source)
