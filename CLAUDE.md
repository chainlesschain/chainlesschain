...
**See [`docs/CLI_COMMANDS_REFERENCE.md`](docs/CLI_COMMANDS_REFERENCE.md)** for the full 159-command reference (thin index → 6 sub-files in `docs/cli/`). Read on demand, not auto-loaded.
...
| CLI | `packages/cli/` | npm CLI (~2MB, 159 commands, Commander) |
