...
| **安全工程师** | [安全机制设计](/安全机制设计) → [UnifiedKey系统](/modules/21_UnifiedKey系统) → [DLP系统](/modules/24_DLP系统)              |
| **AI工程师**   | [AI优化系统](/modules/06_AI优化系统) → [多代理系统](/modules/13_多代理系统) → [推理网络](/modules/38_InferenceNetwork系统) |
| **运维工程师** | [生产强化](/modules/29_ProductionHardening系统) → [Terraform](/modules/28_Terraform系统) → [SIEM](/modules/25_SIEM系统)    |
