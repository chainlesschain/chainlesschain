...
hero:
  name: ChainlessChain
  text: 系统设计文档
  tagline: v5.0.3.1 | 95+ 模块设计 | 139 技能 | CLI 109 命令/0.158.0 | 14800+ 总测试 | V2 规范层 220+ 治理表面（iter16-iter28） | Web Panel 50 routes（Phase A+B+C+D 全量收官）| Web Shell（Phase 1.6 默认）| 面向开发者的架构与实现文档
  image:
    src: /logo.png
