...
/// 远程操控主屏 — Phase 3.3 → Phase 4.5 加第 6 tab "通知"。
///
/// **6 tab horizontal-scroll shell** (Phase 4.5 起从 5-tab segmented 升级):
/// - Terminal (Phase 2 ✓) — 嵌入既有 TerminalListView
/// - Clipboard (Phase 3.3 ✓)
/// - File (Phase 3.4 ✓)
/// - Screenshot (Phase 3.5 ✓)
/// - System (Phase 3.5 ✓)
/// - **Notification (Phase 4.5 ✓ NEW)** — 桌面 push 收件箱 + 历史 + 设置
///
...
/// (与 Discord/Slack 移动端 pattern 一致)。
