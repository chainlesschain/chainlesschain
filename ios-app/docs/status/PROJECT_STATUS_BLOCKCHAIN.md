...
**Chain Management** (2): 6. Switch blockchain network 7. Add custom RPC endpoint

**Transactions** (5): 8. Send native tokens (ETH, MATIC, etc.) 9. View transaction history 10. Check transaction details 11. Estimate gas fees 12. Filter transactions by status

**Token Management** (4): 13. Add custom ERC-20 token 14. Transfer tokens 15. Approve token allowance 16. Remove token from list

**NFT Management** (5): 17. View NFT gallery 18. Transfer NFT (ERC-721) 19. Transfer NFT with quantity (ERC-1155) 20. Add NFT manually 21. View NFT metadata and attributes

**Escrow Workflows** (4): 22. Create escrow contract 23. Fund escrow (buyer) 24. Mark as delivered (seller) 25. Release funds (buyer/arbitrator) 26. Dispute resolution (arbitrator)

**Marketplace Workflows** (6): 27. List NFT for sale 28. Buy listed NFT 29. Make offer on NFT 30. Accept offer (seller) 31. Cancel listing 32. Cancel offer

**DApp Browser** (8): 33. Browse DApp discovery 34. Connect to DApp via WalletConnect 35. Sign message request 36. Send transaction request 37. Manage active sessions 38. Add DApp to favorites 39. Search for DApps 40. Reject malicious requests
