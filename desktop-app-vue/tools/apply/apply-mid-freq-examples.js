...
const fs = require('fs');
const enhancedExamples = require('./mid-freq-enhanced-examples.json');
const tools = require('./src/main/skill-tool-system/builtin-tools.js');

console.log('╔══════════════════════════════════════════════════════════╗');
console.log('║  应用中频工具Examples                                   ║');
console.log('╚══════════════════════════════════════════════════════════╝\n');

const builtinPath = './src/main/skill-tool-system/builtin-tools.js';

// 备份
const backupPath = builtinPath + '.backup-mid-freq-' + Date.now();
...
console.log('═══════════════════════════════════════════════════════════');
console.log(`✅ 成功应用: ${appliedCount}个中频工具的examples`);
console.log('═══════════════════════════════════════════════════════════\n');
...
try {
  ...
  console.log(`✅ 中频工具examples总数: ${totalExamples}`);
  console.log(`✅ 平均每个中频工具: ${(totalExamples / enhancedToolIds.length).toFixed(1)}个examples`);
