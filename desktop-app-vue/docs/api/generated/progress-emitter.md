...
- 更新步进（自动计算百分比）* @param {string} message - 进度消息 * @param {number} increment - 步进增量（默认1）
...
- 直接设置百分比 * @param {number} percent - 百分比 (0-100) * @param {string} message - 进度消息
...
- 设置任务阶段 * @param {string} stage - 阶段（使用 ProgressStage 枚举）* @param {string} message - 消息
