...
app.whenReady().then(async () => {
  ...
  console.log(`  结果: ${conversationPassed}/${conversationHandlers.length} 通过\n`);
  ...
  console.log(`  结果: ${notificationPassed}/${notificationHandlers.length} 通过\n`);

  // 总结
  const totalHandlers = conversationHandlers.length + syncHandlers.length + notificationHandlers.length;
