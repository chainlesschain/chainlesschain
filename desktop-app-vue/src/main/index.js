...
class ChainlessChainApp {
  ...
  setupIPC() {
    ...
    /* ========================================================================
       MIGRATED TO sync/sync-ipc.js (4 handlers)
       已迁移的 handlers:
       - sync:start, sync:get-status, sync:incremental
       - sync:resolve-conflict (commented out)
       ======================================================================== */
    ...
    /* ========================================================================
       MIGRATED TO import/import-ipc.js (5 handlers)
       已迁移的 handlers:
       - import:select-files, import:import-file, import:import-files
       - import:get-supported-formats, import:check-file
       ======================================================================== */
    ...
    /* ========================================================================
       MIGRATED TO notification/notification-ipc.js (4 handlers)
       已迁移的 handlers:
       - notification:mark-read, notification:mark-all-read
       - notification:get-unread-count, notification:send-desktop
       ======================================================================== */

    /* ========================================================================
       MIGRATED TO trade/wallet-ipc.js (15 handlers)
       已迁移的 handlers:
       - wallet:create, wallet:import-mnemonic, wallet:import-private-key
       - wallet:unlock, wallet:lock
       - wallet:sign-transaction, wallet:sign-message
       - wallet:get-balance, wallet:get-all, wallet:get
       - wallet:set-default, wallet:delete
       - wallet:export-private-key, wallet:export-mnemonic
       - wallet:save-external
       ======================================================================== */

    /* ========================================================================
       MIGRATED TO blockchain/blockchain-ipc.js (14 handlers)
       已迁移的 handlers:
       - blockchain:switch-chain, blockchain:get-tx-history, blockchain:get-transaction
       - blockchain:deploy-token, blockchain:deploy-nft, blockchain:mint-nft
       - blockchain:transfer-token, blockchain:get-gas-price, blockchain:estimate-gas
       - blockchain:get-block, blockchain:get-block-number, blockchain:listen-events
       - blockchain:get-deployed-contracts, blockchain:get-deployed-assets
       ======================================================================== */

    /* ========================================================================
       MIGRATED TO blockchain/bridge-ipc.js (7 handlers)
       已迁移的 handlers:
       - bridge:transfer, bridge:get-history, bridge:get-record
       - bridge:register-contract, bridge:get-balance
       - bridge:get-batch-balances, bridge:get-locked-balance
       ======================================================================== */

    /* ========================================================================
       MIGRATED TO blockchain/asset-ipc.js (10 handlers)
       已迁移的 handlers:
       - asset:create, asset:mint, asset:transfer, asset:burn
       - asset:get, asset:get-by-owner, asset:get-all
       - asset:get-history, asset:get-balance, asset:get-blockchain-info
       ======================================================================== */
