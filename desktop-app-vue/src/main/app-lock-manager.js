...
class AppLockManager {
  constructor(options = {}) {
    this.lockFilePath = options.lockFilePath || path.join(app.getPath('userData'), 'app-lock.json');
    this.isLocked = false;
  ...
  setAutoLock(enabled) {
    ...
    console.log('[AppLockManager] Auto lock:', enabled ? 'enabled' : 'disabled');
  }
  ...
  startActivityMonitor() {
    ...
    this.activityTimer = setInterval(() => {
      ...
      if (timeSinceActivity >= this.lockTimeout && !this.isLocked && this.passwordHash) {
