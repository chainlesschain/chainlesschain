  ...
  registerHandlers() {
    ...
    ipcMain.handle("permission:get-effective", async (event, args) => {
      try {
        ...
        const permissions =
          await this.permissionManager.getEffectivePermissions(
            orgId,
            userDID,
            resourceType,
            resourceId,
        ...
        logger.error(
          "[PermissionIPC] Get effective permissions failed:",
          error,
        );
        return { success: false, error: error.message };
      }
    ...
    ipcMain.handle("permission:update-resource", async (event, args) => {
      try {
        ...
        await this.middleware.requirePermission("knowledge.manage")(
          event,
          args,
        );
        ...
        logger.error(
          "[PermissionIPC] Update resource permissions failed:",
          error,
        );
        return { success: false, error: error.message };
      }
    ...
    ipcMain.handle("permission:create-override", async (event, args) => {
      try {
        ...
        logger.error(
          "[PermissionIPC] Create permission override failed:",
          error,
        );
        return { success: false, error: error.message };
      }
    ...
    ipcMain.handle("permission:delete-override", async (event, args) => {
      try {
        ...
        logger.error(
          "[PermissionIPC] Delete permission override failed:",
          error,
        );
        return { success: false, error: error.message };
      }
    ...
    ipcMain.handle("permission:create-template", async (event, args) => {
      try {
        ...
        logger.error(
          "[PermissionIPC] Create permission template failed:",
          error,
        );
        return { success: false, error: error.message };
      }
    ...
    ipcMain.handle("permission:apply-template", async (event, args) => {
      try {
        ...
        logger.error(
          "[PermissionIPC] Apply permission template failed:",
          error,
        );
        return { success: false, error: error.message };
      }
    ...
    ipcMain.handle("permission:get-statistics", async (event, args) => {
      try {
        ...
        logger.error(
          "[PermissionIPC] Get permission statistics failed:",
          error,
        );
        return { success: false, error: error.message };
      }
