...
const PRICING_DATA = {
  ...
  anthropic: {
    ...
    "claude-opus-4-8": { input: 5.0, output: 25.0, cache: 0.5, cacheWrite: 6.25 },
    "claude-opus-4-7": { input: 5.0, output: 25.0, cache: 0.5, cacheWrite: 6.25 },
    "claude-opus-4-6": { input: 5.0, output: 25.0, cache: 0.5, cacheWrite: 6.25 },
    "claude-sonnet-4-6": { input: 3.0, output: 15.0, cache: 0.3, cacheWrite: 3.75 },
    ...
    "claude-haiku-4-5": { input: 1.0, output: 5.0, cache: 0.1, cacheWrite: 1.25 },
    "claude-fable-5": { input: 10.0, output: 50.0, cache: 1.0, cacheWrite: 12.5 },
