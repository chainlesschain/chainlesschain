...
const VOLCENGINE_MODELS = {
  ...
  "doubao-seed-1.6": {
    ...
    description:
      "豆包最新主力模型，支持深度思考模式，256K上下文，适合复杂推理任务",
    recommended: true,
  },
  ...
  "doubao-seed-1.6-flash": {
    ...
    description:
      "快速响应版本，延迟更低，成本更优，支持视频/图像理解，适合实时对话",
    recommended: false,
  },
  ...
  "doubao-seed-1.6-lite": {
    ...
    bestFor: [TaskTypes.COST_EFFECTIVE, TaskTypes.CHAT],
    description:
      "轻量高效版本，支持reasoning_effort调节思考长度，价格最低，适合大规模调用场景",
  },
  ...
  "doubao-pro-32k": {
    ...
    bestFor: [TaskTypes.CHAT, TaskTypes.KNOWLEDGE_QA],
  ...
  "doubao-1.5-vision-pro": {
    ...
    bestFor: [TaskTypes.IMAGE_UNDERSTANDING, TaskTypes.VIDEO_UNDERSTANDING],
  ...
  "doubao-1.5-vision-lite": {
    ...
    bestFor: [TaskTypes.IMAGE_UNDERSTANDING, TaskTypes.COST_EFFECTIVE],
  ...
  "doubao-1.5-thinking-vision-pro": {
    ...
    name: "豆包 1.5 思考视觉版",
    type: "vision",
    capabilities: [ModelCapabilities.VISION, ModelCapabilities.DEEP_THINKING],
    contextLength: 128000,
    pricing: {
      input: 0.0025,
      output: 0.0075,
    ...
    bestFor: [TaskTypes.COMPLEX_REASONING, TaskTypes.IMAGE_UNDERSTANDING],
  ...
  "doubao-seedream-4.5": {
    ...
    bestFor: [TaskTypes.IMAGE_CREATION, TaskTypes.CREATIVE_WRITING],
  ...
  "doubao-seedream-4.0": {
    ...
    bestFor: [TaskTypes.IMAGE_CREATION],
  ...
  "doubao-seedream-3.0-t2i": {
    ...
    bestFor: [TaskTypes.IMAGE_CREATION, TaskTypes.COST_EFFECTIVE],
  ...
  "doubao-seededit-3.0-i2i": {
    ...
    type: "image_editing",
    capabilities: [ModelCapabilities.IMAGE_EDITING],
    pricing: {
      standard: 0.05,
    },
    bestFor: [TaskTypes.IMAGE_CREATION],
  ...
  "doubao-seedance-1.5-pro": {
    ...
    bestFor: [TaskTypes.VIDEO_CREATION],
  ...
  "doubao-seedance-1.0-lite": {
    ...
    bestFor: [TaskTypes.VIDEO_CREATION, TaskTypes.COST_EFFECTIVE],
  ...
  "doubao-embedding-large": {
    ...
    bestFor: [TaskTypes.TEXT_EMBEDDING, TaskTypes.KNOWLEDGE_QA],
  ...
  "doubao-embedding": {
    ...
    bestFor: [TaskTypes.TEXT_EMBEDDING, TaskTypes.COST_EFFECTIVE],
  ...
  "doubao-embedding-vision": {
    ...
    type: "embedding",
    capabilities: [ModelCapabilities.VISION_EMBEDDING],
    dimensions: 1536,
    pricing: {
      input: 0.0003,
      imagePrice: 0.001, // 每张图片
    },
    bestFor: [TaskTypes.IMAGE_EMBEDDING],
  ...
  "doubao-seed3d-1.0": {
    ...
    name: "豆包 3D生成",
    type: "3d_generation",
    capabilities: [ModelCapabilities.MODEL_3D],
    pricing: {
  ...
  "doubao-1.5-ui-tars": {
    ...
    name: "豆包 UI Tars",
    type: "vision",
    capabilities: [ModelCapabilities.GUI_AGENT, ModelCapabilities.VISION],
    pricing: {
      input: 0.002,
      output: 0.006,
    },
    bestFor: [TaskTypes.GUI_AUTOMATION],
  ...
  "doubao-seed-1.6-code": {
    ...
    name: "豆包 Code",
    type: "text",
    capabilities: [ModelCapabilities.CODE_GENERATION],
    contextLength: 128000,
    pricing: {
      input: 0.0006,
      output: 0.0018,
    },
    bestFor: [TaskTypes.CODE_WRITING],
...
class VolcengineModelSelector {
  ...
  selectModel(taskType, options = {}) {
    ...
    if (candidates.length === 0) {
      logger.warn(
        `[ModelSelector] 未找到适合 ${taskType} 的模型，使用默认模型`,
      );
    ...
    if (contextLength > 0) {
      candidates = candidates.filter(
        (model) => model.contextLength && model.contextLength >= contextLength,
      );
    }
    ...
    if (preferCost) {
      ...
      candidates.sort((a, b) => {
        const scoreA =
          (a.recommended ? 10 : 0) + (a.id.includes("pro") ? 5 : 0);
        const scoreB =
          (b.recommended ? 10 : 0) + (b.id.includes("pro") ? 5 : 0);
    ...
    logger.info(
      `[ModelSelector] 为任务 ${taskType} 选择模型: ${selectedModel.name}`,
    );
    logger.info(`[ModelSelector] 模型能力:`, selectedModel.capabilities);
    logger.info(
      `[ModelSelector] 预估成本: ¥${selectedModel.pricing?.input || "N/A"}/百万tokens`,
    );
