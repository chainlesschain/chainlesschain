...
async function executeCommand(method, params) {
  ...
  switch (method) {
    ...
    // Element Interactions + DOM Mutation Observer moved to ./handlers/dom.js

    // Event Listener Inspector moved to ./handlers/events.js
    ...
    // Accessibility (accessibility.*) moved to ./handlers/accessibility.js

    // Performance (performance.*) moved to ./handlers/performance.js
    ...
    // Drag and Drop + Selection & Range moved to ./handlers/selection-dragdrop.js
    ...
    // Font handlers (Inspector + Local Font Access) moved to ./handlers/fonts.js
    ...
    // Reader Mode (article.*) + Web Annotation (annotation.*) handlers moved to
...
// Page Operations (getContent) handler moved to ./handlers/page.js (Phase 1).
...
// Clipboard handlers moved to ./handlers/clipboard.js (Phase 1 split).

// Cookie handlers moved to ./handlers/storage.js (Phase 1 split).

// Download handlers moved to ./handlers/downloads.js (Phase 1 split).

// Window handlers moved to ./handlers/windows.js (Phase 1 split).

// Web storage handlers moved to ./handlers/storage.js (Phase 1 split).
...
// Performance handlers moved to ./handlers/performance.js (Phase 1 split).

// CSS Injection handlers moved to ./handlers/page.js (Phase 1 split).

// Accessibility handlers moved to ./handlers/accessibility.js (Phase 1 split).
...
// WebSocket debugging handlers moved to ./handlers/devtools-debug.js (Phase 1).

// Service Worker handlers moved to ./handlers/devtools-debug.js (Phase 1 split).

// Cache Storage handlers moved to ./handlers/cache.js (Phase 1 split).

// Security Info handlers moved to ./handlers/devtools-debug.js (Phase 1 split).

// ensureDebuggerAttached moved to ./handlers/_shared.js (Phase 0 split).

// Animation Control handlers moved to ./handlers/devtools-inspect.js (Phase 1).

// Layout Inspection handlers moved to ./handlers/devtools-inspect.js (Phase 1).

// Coverage Analysis handlers moved to ./handlers/devtools-inspect.js (Phase 1).

// Memory Profiling handlers moved to ./handlers/devtools-inspect.js (Phase 1).

// DOM Mutation Observer handlers moved to ./handlers/dom.js (Phase 1 split).

// Event Listener Inspector handlers moved to ./handlers/events.js (Phase 1).
...
// Font Inspector handlers moved to ./handlers/fonts.js (Phase 1 split).
...
// Storage Inspector handlers moved to ./handlers/storage.js (Phase 1 split).

// Network throttling handlers moved to ./handlers/network.js (Phase 1 split).
...
// Advanced clipboard handlers moved to ./handlers/clipboard.js (Phase 1 split).
...
// Phase 21 Accessibility handlers moved to ./handlers/accessibility.js (Phase 1).

// Phase 21 Performance handlers moved to ./handlers/performance.js (Phase 1).
...
// checkMixedContent + getCertificateInfo (Phase 21 duplicates that hoisting made
// effective) moved to ./handlers/devtools-debug.js (Phase 1 split); both
// security.checkMixedContent / security.getCertificate keys now resolve there.
...
// Network timing handlers moved to ./handlers/network.js (Phase 1 split).
...
// Advanced IndexedDB handlers moved to ./handlers/indexeddb.js (Phase 1 split).
...
// Drag and Drop + Selection & Range handlers moved to
// ./handlers/selection-dragdrop.js (Phase 1 split).
...
// Network Information API handlers moved to ./handlers/network.js (Phase 1 split).
...
// Local Font Access API handlers moved to ./handlers/fonts.js (Phase 1 split).
...
// Reader Mode & Article Extraction handlers moved to ./handlers/page.js (Phase 1).

// Web Annotation handlers moved to ./handlers/page.js (Phase 1 split).
