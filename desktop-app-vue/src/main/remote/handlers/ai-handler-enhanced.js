...
class AICommandHandlerEnhanced extends EventEmitter {
  ...
  getCloudModels(provider) {
    ...
    if (provider === 'all' || provider === 'anthropic') {
      cloudModels.push(
        { id: 'claude-opus-4-8', name: 'Claude Opus 4.8', provider: 'anthropic', capabilities: ['chat', 'function_calling'], maxTokens: 200000 },
        { id: 'claude-sonnet-4-6', name: 'Claude Sonnet 4.6', provider: 'anthropic', capabilities: ['chat', 'function_calling'], maxTokens: 200000 },
        { id: 'claude-haiku-4-5', name: 'Claude Haiku 4.5', provider: 'anthropic', capabilities: ['chat'], maxTokens: 200000 }
      );
    }
