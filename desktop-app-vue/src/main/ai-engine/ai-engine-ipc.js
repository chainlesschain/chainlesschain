...
class AIEngineIPC {
  ...
  registerHandlers(mainWindow) {
    ...
    ipcMain.handle('ai:processInput', async (event, { input, context }) => {
      try {
        console.log('[AI Engine IPC] 处理用户输入:', input);
        ...
        console.error('[AI Engine IPC] 处理失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('ai:getHistory', async (_event, limit = 10) => {
      try {
        ...
        console.error('[AI Engine IPC] 获取历史失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('ai:clearHistory', async () => {
      try {
        ...
        console.error('[AI Engine IPC] 清除历史失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('ai:getAvailableTools', async () => {
      try {
        ...
        console.error('[AI Engine IPC] 获取工具列表失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('web-engine:generate', async (_event, options) => {
      try {
        console.log('[Web Engine IPC] 生成Web项目:', options);
        ...
        console.error('[Web Engine IPC] 生成失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('web-engine:getTemplates', async () => {
      try {
        ...
        console.error('[Web Engine IPC] 获取模板失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('web-engine:startPreview', async (_event, projectPath, port) => {
      try {
        ...
        console.error('[Web Engine IPC] 启动预览失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('web-engine:stopPreview', async () => {
      try {
        ...
        console.error('[Web Engine IPC] 停止预览失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('web-engine:restartPreview', async (_event, projectPath) => {
      try {
        ...
        console.error('[Web Engine IPC] 重启预览失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('web-engine:getPreviewStatus', async () => {
      try {
        ...
        console.error('[Web Engine IPC] 获取预览状态失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('web-engine:changePreviewPort', async (_event, newPort) => {
      try {
        ...
        console.error('[Web Engine IPC] 更改端口失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('document-engine:generate', async (_event, options) => {
      try {
        console.log('[Document Engine IPC] 生成文档:', options);
        ...
        console.error('[Document Engine IPC] 生成失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('document-engine:getTemplates', async () => {
      try {
        ...
        console.error('[Document Engine IPC] 获取模板失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('data-engine:readCSV', async (_event, filePath) => {
      try {
        ...
        console.error('[Data Engine IPC] 读取CSV失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('data-engine:writeCSV', async (_event, filePath, data) => {
      try {
        ...
        console.error('[Data Engine IPC] 写入CSV失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('data-engine:analyze', async (_event, data, options) => {
      try {
        ...
        console.error('[Data Engine IPC] 分析数据失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('data-engine:generateChart', async (_event, data, options) => {
      try {
        ...
        console.error('[Data Engine IPC] 生成图表失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('data-engine:generateReport', async (_event, analysisResults, outputPath) => {
      try {
        ...
        console.error('[Data Engine IPC] 生成报告失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('git-auto-commit:start', async (_event, projectId, repoPath) => {
      try {
        ...
        console.error('[Git Auto Commit IPC] 启动失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('git-auto-commit:stop', async (_event, projectId) => {
      try {
        ...
        console.error('[Git Auto Commit IPC] 停止失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('git-auto-commit:stopAll', async () => {
      try {
        ...
        console.error('[Git Auto Commit IPC] 停止所有失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('git-auto-commit:setInterval', async (_event, interval) => {
      try {
        ...
        console.error('[Git Auto Commit IPC] 设置间隔失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('git-auto-commit:setEnabled', async (_event, enabled) => {
      try {
        ...
        console.error('[Git Auto Commit IPC] 设置启用状态失败:', error);
        return {
          success: false,
          error: error.message,
        };
    ...
    ipcMain.handle('git-auto-commit:getWatchedProjects', async () => {
      try {
        ...
        console.error('[Git Auto Commit IPC] 获取监控项目失败:', error);
        return {
          success: false,
          error: error.message,
        };
  ...
  unregisterHandlers() {
    ...
    console.log('[AI Engine IPC] 所有IPC handlers已注销');
  }
}
