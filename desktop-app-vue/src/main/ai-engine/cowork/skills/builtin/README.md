...
| 技能                 | 类别          | Handler | 说明                                                        |
| -------------------- | ------------- | ------- | ----------------------------------------------------------- |
| brainstorming        | general       | ✅      | 创意头脑风暴（自由思考/思维导图/SWOT/六顶帽/SCAMPER方法）   |
| debugging-strategies | development   | ✅      | 系统调试策略（诊断/二分法/执行追踪/假设驱动/小黄鸭调试）    |
| api-design           | development   | ✅      | API设计（RESTful设计/审查/OpenAPI生成/版本策略/错误码设计） |
