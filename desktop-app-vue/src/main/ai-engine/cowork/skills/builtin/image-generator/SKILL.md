...
execution-capabilities: [data:result, data:task, filesystem:read, filesystem:write, host:environment, host:logger, host:media, host:network, network:http, process:cwd]
handler: ./handler.js
