...
execution-capabilities: [data:result, data:task, filesystem:read, host:code-agent, host:filesystem, host:logger, host:process, process:cwd, process:execute, runtime:time]
handler: ./handler.js
---
