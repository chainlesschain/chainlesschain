...
execution-capabilities: [data:result, data:task, filesystem:read, host:environment, host:filesystem, host:logger, host:network, host:process, network:http, process:cwd, process:execute, runtime:crypto]
handler: ./handler.js
tools:
  - file_read
  - file_write
