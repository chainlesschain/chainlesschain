...
execution-capabilities: [data:result, data:task, filesystem:read, filesystem:write, host:environment, host:filesystem, host:logger, runtime:random, runtime:time]
handler: ./handler.js
