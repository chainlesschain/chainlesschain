...
user-invocable: true
tags: [performance, optimization, profiling, memory, cpu, rendering, database]
capabilities:
  [
...
instructions: |
  Use this skill when the user wants performance analysis or optimization
  suggestions. Analyze code for algorithmic complexity, memory leaks, I/O
  bottlenecks, unnecessary re-renders, and slow database queries. Provide
  concrete optimization suggestions rated by impact and implementation difficulty.
examples:
  - input: "/performance-optimizer src/main/rag/hybrid-search-engine.js"
    output: "Performance score with bottleneck list and optimization suggestions"
  - input: "/performance-optimizer src/renderer/stores/ --focus memory --depth deep"
    output: "Deep memory analysis: closure leaks, large object retention, unreleased refs"
  - input: "/performance-optimizer src/main/llm/context-engineering.js --benchmark"
