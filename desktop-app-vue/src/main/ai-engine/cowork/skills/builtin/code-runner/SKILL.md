...
execution-capabilities: [data:result, data:task, filesystem:read, filesystem:write, host:environment, host:filesystem, host:logger, host:module-load, process:cwd, process:execute, process:module-path, runtime:time, system:inspect]
handler: ./handler.js
