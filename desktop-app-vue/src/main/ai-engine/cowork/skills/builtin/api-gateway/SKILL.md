...
execution-capabilities: [data:result, data:task, filesystem:read, filesystem:write, host:environment, host:filesystem, host:logger, host:network, network:http, runtime:time]
handler: ./handler.js
