...
execution-capabilities: [data:result, data:task, filesystem:read, filesystem:write, host:filesystem, host:logger, host:process, process:cwd, process:execute, runtime:time, runtime:timers, system:inspect]
handler: ./handler.js
---
