...
execution-capabilities: [data:result, data:task, filesystem:read, host:logger, host:process, host:skill, process:cwd, process:execute, runtime:time, system:inspect]
handler: ./handler.js
---
