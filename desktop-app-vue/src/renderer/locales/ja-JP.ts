...
const jaJP: LocaleMessages = {
  ...
  enterprise: {
    ...
    memberJoinRequest: 'メンバー参加申請',
    dashboardStats: 'ダッシュボード統計',
    orgSettings: '組織設定',
    departmentLead: '部門リーダー',
  },

  performance: {
    monitoring: 'パフォーマンス監視',
    autoTuning: '自動チューニング',
    tuningRules: 'チューニングルール',
    enableRule: 'ルール有効化',
    disableRule: 'ルール無効化',
    manualTune: '手動チューニング',
    tuningHistory: 'チューニング履歴',
    cpuUsage: 'CPU使用率',
    memoryUsage: 'メモリ使用率',
    diskUsage: 'ディスク使用率',
    rendererFps: 'レンダラーFPS',
    domNodes: 'DOMノード数',
  },
  ...
  analytics: {
    ...
    timeSeries: '時系列',
    kpis: 'KPI',
    totalAICalls: 'AI呼び出し合計',
    totalTokens: 'トークン合計',
    tokenCost: 'トークンコスト',
    skillExecutions: 'スキル実行回数',
    successRate: '成功率',
    errorCount: 'エラー数',
    activePeers: 'アクティブピア',
    uptime: '稼働時間',
  ...
  collaboration: {
    realTimeEditing: 'リアルタイム編集',
    collaborators: 'コラボレーター',
    connected: '接続済み',
    disconnected: '切断済み',
    synced: '同期済み',
    syncing: '同期中...',
    cursorPresence: 'カーソルプレゼンス',
    undoRedo: '元に戻す/やり直す',
  ...
  storage: {
    ...
    startNode: 'ノード開始',
    stopNode: 'ノード停止',
    pinnedContent: 'ピン留めコンテンツ',
    addContent: 'コンテンツ追加',
    uploadFile: 'ファイルアップロード',
    storageQuota: 'ストレージクォータ',
    garbageCollect: 'ガベージコレクション',
    embeddedMode: '組み込みモード',
    externalMode: '外部モード',
    peerCount: 'ピア数',
    cid: 'CID',
    encrypted: '暗号化済み',
