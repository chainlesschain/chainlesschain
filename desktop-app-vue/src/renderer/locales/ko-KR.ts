...
const koKR: LocaleMessages = {
  ...
  analytics: {
    ...
    timeSeries: '시계열',
    kpis: 'KPI',
    totalAICalls: 'AI 호출 총수',
    totalTokens: '총 토큰 수',
    tokenCost: '토큰 비용',
    skillExecutions: '스킬 실행 횟수',
    successRate: '성공률',
    errorCount: '오류 수',
    activePeers: '활성 피어',
    uptime: '가동 시간',
  ...
  collaboration: {
    realTimeEditing: '실시간 편집',
    collaborators: '협업자',
    connected: '연결됨',
    disconnected: '연결 끊김',
    synced: '동기화됨',
    syncing: '동기화 중...',
    cursorPresence: '커서 감지',
