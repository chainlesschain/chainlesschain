<template>
  ...
  >
    ...
    <div class="ao-toolbar">
      <span class="ao-subtitle">Autonomous Operations</span>
      <a-space size="small">
        <a-button size="small" @click="showAlertConfigModal = true">
    ...
    <a-row :gutter="[16, 16]" class="ao-stats">
      <a-col :xs="12" :sm="6">
        <a-statistic
          title="活跃事故"
              ...
              >
                <a-descriptions :column="1" size="small">
                  ...
                  <a-descriptions-item label="SLA">
                    ...
                    <span style="margin-left: 16px">
                      实际 MTTR: {{ item.slaMetrics?.actualMTTR }}min
                    </span>
                    <a-tag
                ...
                <a-timeline style="margin-top: 8px">
                  <a-timeline-item
                    ...
                    :key="idx"
                  >
                    <span style="color: rgba(0, 0, 0, 0.45); margin-right: 8px">
                      {{ entry.time }}
                    </span>
                    {{ entry.event }}
                  </a-timeline-item>
