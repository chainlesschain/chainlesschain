<template>
  <div class="llmperf-widget">
    <div class="widget-header">
      <ThunderboltOutlined class="widget-icon" />
      <span class="widget-title">LLM 性能</span>
    </div>
...
const actions: LlmPerfAction[] = [
  { id: "budget", label: "预算", kind: "查看", args: "budget" },
  { id: "cache", label: "缓存", kind: "查看", args: "cache" },
  { id: "alerts", label: "告警", kind: "管理", args: "alerts" },
];

function pick(action: LlmPerfAction): void {
  dispatchSlash("builtin:openLlmPerformancePanel", {
    trigger: "/llm-performance",
    args: action.args,
  });
}
