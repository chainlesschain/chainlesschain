<template>
  <div class="ai-chat-widget">
    <div class="widget-header">
      <MessageOutlined class="widget-icon" />
      <span class="widget-title">AI 对话</span>
    </div>
...
const actions: ChatAction[] = [
  { id: "new", label: "新对话", kind: "新建", args: "new" },
  { id: "status", label: "模型状态", kind: "查看", args: "status" },
  { id: "switch", label: "切换模型", kind: "切换", args: "switch" },
];

function pick(action: ChatAction): void {
...
.widget-icon {
  color: var(--cc-shell-accent, #1677ff);
  font-size: 16px;
}
