<template>
  <a-modal
    ...
    title="Session Core · Managed Agents"
  ...
  >
    ...
    <a-tabs v-model:active-key="activeTab">
      ...
      <a-tab-pane key="policy" tab="Policy">
        ...
        <pre v-if="policyResult" class="sc-pre">{{
...
async function handlePark(id: string): Promise<void> {
...
async function handleGetPolicy(): Promise<void> {
...
async function handleRefreshUsage(): Promise<void> {
  await store.refreshUsage();
}

async function handleEnableBeta(): Promise<void> {
