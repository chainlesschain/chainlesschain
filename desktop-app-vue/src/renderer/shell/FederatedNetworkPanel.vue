<template>
  ...
  >
    ...
    <div class="fn-toolbar">
      <span class="fn-subtitle">Federated Agent Network</span>
      <a-space size="small">
        <a-button size="small" :loading="store.loading" @click="handleDiscover">
    ...
    <a-row :gutter="[16, 16]" class="fn-stats">
      <a-col :xs="12" :sm="6">
        <a-statistic
          title="在线节点"
              ...
              <a-list-item-meta>
                ...
                <template #description>
                  ...
                  <div style="margin-top: 4px">
                    <a-tag v-for="skill in item.skills" :key="skill">
                      {{ skill }}
                    </a-tag>
                  </div>
                </template>
...
// Bind live listeners (bind-once guarded in store) + load all on open.
watch(
  () => props.open,
  async (isOpen) => {
    if (!isOpen) {
