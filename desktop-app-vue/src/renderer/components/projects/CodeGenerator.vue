      ...
      <a-tabs v-model:active-key="activeTab">
        ...
        <a-tab-pane key="fix" tab="Bug修复">
          <a-form :model="fixForm" layout="vertical">
            ...
            <a-form-item>
              <a-button type="primary" :loading="fixing" @click="handleFix">
                <tool-outlined /> 修复Bug
              </a-button>
            </a-form-item>
          </a-form>
...
// 格式化 LLM 输出 — 先 escape 文本防 XSS，再叠加格式化标签，最后 DOMPurify
...
const formatExplanation = (text) => {
  ...
  return safeHtml(escapeHtml(text).replace(/\n/g, "<br>"));
};
