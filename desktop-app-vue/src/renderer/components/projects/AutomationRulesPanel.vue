              ...
              <template #description>
                ...
                <a-space size="large">
                  ...
                  <span v-if="item.last_run_at">
                    <strong>最后执行:</strong> {{ formatTime(item.last_run_at) }}
                  </span>
                  <span>
          ...
          <div v-if="ruleForm.triggerType === 'schedule'">
            ...
            >
              ...
              <span class="form-hint">
                快捷设置:
                <a @click="ruleForm.triggerConfig.cron = '0 21 * * *'">每天21:00</a> |
                <a @click="ruleForm.triggerConfig.cron = '0 */1 * * *'">每小时</a> |
                <a @click="ruleForm.triggerConfig.cron = '0 9 * * 1'">每周一9:00</a>
              </span>
            </a-form-item>
          </div>
...
async function handleSubmit() {
  ...
  try {
    ...
    if (editingRule.value) {
      // 更新
      await window.electronAPI.automation.updateRule(editingRule.value.id, data);
