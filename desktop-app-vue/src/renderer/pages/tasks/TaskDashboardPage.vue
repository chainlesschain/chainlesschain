<template>
  <div class="task-dashboard-page">
    ...
    <a-row :gutter="16" class="stats-row">
      <a-col :span="6">
        <a-card>
          <a-statistic title="待办任务" :value="stats.todoCount" :value-style="{ color: '#1890ff' }">
      ...
      <a-col :span="6">
        <a-card>
          <a-statistic title="进行中" :value="stats.inProgressCount" :value-style="{ color: '#faad14' }">
      ...
      <a-col :span="6">
        <a-card>
          <a-statistic title="已过期" :value="stats.overdueCount" :value-style="{ color: '#ff4d4f' }">
      ...
      <a-spin :spinning="loading">
        <a-row :gutter="16">
          <a-col v-for="board in boards" :key="board.id" :span="8">
            ...
            >
              <template #cover>
                <div class="board-cover" :style="{ backgroundColor: board.color || '#1890ff' }">
    ...
    >
      <a-form :model="newBoard" layout="vertical">
        ...
        <a-form-item label="描述">
          <a-textarea v-model:value="newBoard.description" placeholder="看板描述" />
        </a-form-item>
