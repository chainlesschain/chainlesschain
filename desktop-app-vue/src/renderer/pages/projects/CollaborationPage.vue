        ...
        <a-tab-pane key="invitations" tab="邀请通知">
          <template #tab>
            <span>
              <MailOutlined />
              邀请通知
              <a-badge v-if="pendingInvitations.length > 0" :count="pendingInvitations.length" />
            </span>
          </template>
        </a-tab-pane>
      </a-tabs>
      ...
      <div v-if="pendingInvitations.length > 0" class="invitations-list">
        ...
        >
          <div class="invitation-header">
            <a-avatar :size="48" :style="{ backgroundColor: getAvatarColor(invitation.inviter.did) }">
          ...
          <div class="invitation-actions">
            <a-button type="primary" @click="handleAcceptInvitation(invitation.id)">
              <CheckOutlined />
              接受
            </a-button>
      ...
      <div v-if="viewMode === 'grid'" class="projects-grid">
        ...
        >
          ...
          <div class="card-footer">
            <a-button type="primary" block @click="handleViewProject(project.id)">
              <EyeOutlined />
              打开项目
            </a-button>
          </div>
            ...
            <a-dropdown>
              ...
              <template #overlay>
                <a-menu @click="({ key }) => handleAction(key, project.id)">
                  <a-menu-item key="manage" v-if="project.isOwner">
                    <SettingOutlined />
                    管理协作者
                  </a-menu-item>
                  <a-menu-item key="leave" v-if="!project.isOwner">
                    <LogoutOutlined />
                    退出协作
                  </a-menu-item>
                </a-menu>
