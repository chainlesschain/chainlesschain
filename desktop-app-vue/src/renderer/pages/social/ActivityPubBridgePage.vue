...
<template>
  <div class="activitypub-bridge-page">
    <a-page-header
      title="ActivityPub Bridge"
      sub-title="Federated social network integration"
    />
    ...
    <a-tabs v-model:active-key="activeTab">
      ...
      >
        <a-row :gutter="16">
          <a-col :span="6">
            <a-statistic
              title="Local Actors"
              :value="syncStatus.actorCount"
            />
          </a-col>
          <a-col :span="6">
            <a-statistic
              title="Published"
              :value="syncStatus.published"
            />
          </a-col>
          <a-col :span="6">
            <a-statistic
              title="Received"
              :value="syncStatus.received"
            />
          </a-col>
          <a-col :span="6">
            <a-statistic
        ...
        >
          <a-descriptions-item label="Domain">
            {{ syncStatus.domain || 'Not configured' }}
          </a-descriptions-item>
          <a-descriptions-item label="Initialized">
            <a-tag :color="syncStatus.initialized ? 'green' : 'red'">
      ...
      <a-tab-pane
        key="actor"
        tab="Actor Management"
      >
        <a-card
          title="Create Local Actor"
          :bordered="false"
        >
          <a-form layout="vertical">
            <a-form-item label="DID">
              <a-input
                v-model:value="actorForm.did"
                placeholder="did:chainlesschain:..."
              />
            </a-form-item>
            <a-form-item label="Username">
              <a-input
                v-model:value="actorForm.username"
                placeholder="preferred_username"
              />
            </a-form-item>
            <a-form-item label="Display Name">
              <a-input
                v-model:value="actorForm.displayName"
                placeholder="Display Name"
              />
            </a-form-item>
            <a-form-item label="Bio">
              <a-textarea
                v-model:value="actorForm.bio"
          ...
          >
            ...
            >
              <a-descriptions-item label="Address">
                {{ webfingerResult.address }}
              </a-descriptions-item>
              <a-descriptions-item label="Actor URL">
                {{ webfingerResult.actorUrl || 'N/A' }}
              </a-descriptions-item>
              <a-descriptions-item label="Aliases">
                <a-tag
                  v-for="alias in (webfingerResult.aliases || [])"
                  :key="alias"
                >
                  {{ alias }}
                </a-tag>
      ...
      >
        <a-card
          title="Publish to Federation"
          :bordered="false"
        >
          <a-form layout="vertical">
            <a-form-item label="Actor DID">
              <a-input
                v-model:value="publishForm.actorDid"
                placeholder="did:chainlesschain:..."
              />
            </a-form-item>
