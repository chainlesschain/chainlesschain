  ...
  <div class="plugin-publisher">
    ...
    <div class="publisher-content">
        ...
        >
          ...
          <a-form-item label="分类" required>
            ...
            >
              ...
              <a-select-option value="integration">第三方集成</a-select-option>
      ...
      <div v-show="currentStep === 2" class="step-content">
        ...
        <a-checkbox-group v-model:value="pluginInfo.permissions" style="width: 100%">
          <a-row :gutter="[16, 16]">
            <a-col :span="12" v-for="perm in availablePermissions" :key="perm.value">
          ...
          <template #extra>
            <a-descriptions bordered :column="2">
              ...
              <a-descriptions-item label="权限" :span="2">
                <a-tag v-for="perm in pluginInfo.permissions" :key="perm" color="orange">
                  {{ getPermissionLabel(perm) }}
                </a-tag>
              </a-descriptions-item>
            </a-descriptions>

            <a-checkbox v-model:checked="agreedToTerms" style="margin-top: 24px">
              我已阅读并同意
