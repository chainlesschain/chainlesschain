  ...
  <div class="message-queue-page">
    ...
    >
      <template #extra>
        ...
        <a-button type="primary" @click="handleRetryAll">
          <RedoOutlined />
          重试全部
        </a-button>
      </template>
    ...
    <div class="queue-content">
      <a-row :gutter="24">
        <!-- Outgoing Messages -->
        <a-col :xs="24" :lg="12">
          <a-card title="待发送消息" class="queue-card">
            <template #extra>
              <a-space>
                <a-badge
            ...
            <a-spin :spinning="loading">
              ...
              <a-empty v-else description="没有待发送消息" />
            </a-spin>
          </a-card>
        </a-col>
        ...
        <!-- Incoming Messages -->
        <a-col :xs="24" :lg="12">
          <a-card title="待接收消息" class="queue-card">
            <template #extra>
              <a-space>
                <a-badge
            ...
            <a-spin :spinning="loading">
              ...
              <a-empty v-else description="没有待接收消息" />
            </a-spin>
          </a-card>
        </a-col>
      </a-row>
      ...
      <!-- Statistics -->
      <a-card title="队列统计" class="stats-card">
        <a-row :gutter="16">
          <a-col :xs="12" :sm="6">
            <a-statistic title="待发送" :value="outgoingPending" suffix="条">
              <template #prefix>
          ...
          <a-col :xs="12" :sm="6">
            <a-statistic title="发送失败" :value="outgoingError" suffix="条">
              <template #prefix>
          ...
          <a-col :xs="12" :sm="6">
            <a-statistic title="待接收" :value="incomingPending" suffix="条">
              <template #prefix>
          ...
          <a-col :xs="12" :sm="6">
            <a-statistic title="总计" :value="totalMessages" suffix="条">
              <template #prefix>
...
export default {
  ...
  setup() {
    ...
    const handleRetryAll = async () => {
      const errorMessages = outgoingMessages.value.filter(
        (m) => m.status === "error",
      );
