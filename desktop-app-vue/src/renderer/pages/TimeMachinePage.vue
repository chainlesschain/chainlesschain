        ...
        <a-tab-pane key="timeline" tab="Timeline">
          <a-spin :spinning="store.loading">
            <div v-if="store.hasTimelinePosts" class="timeline-list">
              <a-list :data-source="store.timelinePosts" item-layout="vertical">
            ...
            <a-empty v-else description="No timeline entries for this date" />
          </a-spin>
        </a-tab-pane>
            ...
            <a-row :gutter="[16, 16]">
              ...
              <a-col :span="12">
                <a-card title="Sentiment Trend" size="small">
                  <template
                    v-if="
                      store.sentimentTrend && store.sentimentTrend.length > 0
                    "
                  >
                  ...
                  >
                    <div class="heatmap-summary">
                      ...
                      <a-statistic
                        ...
                        style="margin-bottom: 12px"
                      />
                      <a-statistic title="Peak Day" :value="peakHeatmapDay" />
                    </div>
                  </template>
