...
export default defineComponent({
  ...
  setup() {
    ...
    const loadTemplates = async () => {
      try {
        const result = await window.electron.ipcRenderer.invoke('permission:get-templates', {
          orgId: orgId.value
        });
    ...
    const loadGroups = async () => {
      try {
        const result = await window.electron.ipcRenderer.invoke('permission:get-groups', {
          orgId: orgId.value
        });
