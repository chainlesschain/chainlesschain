...
const socialPages = createRouteGroup("social", {
  ...
  livestream: () =>
    import(
      /* webpackChunkName: "social-livestream" */ "../pages/LivestreamPage.vue"
    ),
});
...
const coworkPages = createRouteGroup("cowork", {
  ...
  tasks: () =>
    import(/* webpackChunkName: "cowork-tasks" */ "../pages/TaskMonitor.vue"),
  skills: () =>
    import(/* webpackChunkName: "cowork-skills" */ "../pages/SkillManager.vue"),
  analytics: () =>
    import(
...
const enterpriseV1Pages = createRouteGroup("enterprise-v1", {
  orgManagement: () =>
    import(
      /* webpackChunkName: "enterprise-org" */ "../pages/enterprise/EnterpriseOrgPage.vue"
    ),
  ipfsStorage: () =>
    import(
      /* webpackChunkName: "ipfs-storage" */ "../pages/IPFSStoragePage.vue"
    ),
  analyticsDashboard: () =>
    import(
  ...
  },
  {
    ...
    children: [
      ...
      // ===== 工作流优化 =====
      {
        ...
        component: () =>
          import("../components/WorkflowOptimizationsDashboard.vue"),
        meta: { title: "工作流优化" },
      },
      // Web IDE
      {
      ...
      },
      {
        ...
        component: () =>
          import("../pages/crossorg/SharedWorkspaceDetailPage.vue"),
        meta: { title: "共享工作空间详情" },
      },
      {
      ...
      // ===== 插件市场 (v0.34.0) =====
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "plugin-marketplace" */ "../pages/PluginMarketplacePage.vue"
          ),
        meta: { title: "插件市场" },
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "plugin-detail" */ "../pages/PluginDetailPage.vue"
          ),
        meta: { title: "插件详情" },
      },
      {
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "agent-template-editor" */ "../pages/AgentTemplateEditorPage.vue"
          ),
        meta: { title: "代理模板编辑" },
      },
      // ===== SSO 企业认证 (v0.34.0) =====
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "sso-login" */ "../pages/SSOLoginPage.vue"
          ),
        meta: { title: "企业单点登录" },
      },
      {
      ...
      // ===== MCP 社区 (v0.34.0) =====
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "mcp-marketplace" */ "../pages/MCPServerMarketplace.vue"
          ),
      ...
      // ===== Tools Explorer (v0.35.0) =====
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "tools-explorer" */ "../pages/ToolsExplorerPage.vue"
          ),
      ...
      // ===== Demo 模板中心 (v0.35.0) =====
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "demo-templates" */ "../pages/DemoTemplatesPage.vue"
          ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "multimodal-collab" */ "../pages/MultimodalCollabPage.vue"
          ),
        meta: { title: "多模态协作" },
      },
      {
      ...
      // ===== Social AI Insights (v1.1.0 Phase 42) =====
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "social-insights" */ "../pages/social/SocialInsightsPage.vue"
          ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "compliance-dashboard" */ "../pages/enterprise/ComplianceDashboardPage.vue"
          ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "scim-integration" */ "../pages/enterprise/SCIMIntegrationPage.vue"
          ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "activitypub-bridge" */ "../pages/social/ActivityPubBridgePage.vue"
          ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "evomap-browser" */ "../pages/evomap/EvoMapBrowser.vue"
          ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "ble-devices" */ "../pages/security/BLEDevicesPage.vue"
          ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "nostr-bridge" */ "../pages/social/NostrBridgePage.vue"
          ),
      ...
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "zkp-credentials" */ "../pages/ZKPCredentialsPage.vue"
          ),
        meta: { title: "ZKP Verifiable Credentials" },
      },
      {
...
router.onError((error, to) => {
  ...
  if (currentRetry >= MAX_DYNAMIC_IMPORT_RETRIES) {
    logger.error("[Router] Dynamic import failed after retries", {
      path: key,
      error,
    });
    return;
