...
const PermissionMiddleware = require('../src/main/organization/permission-middleware');
const PermissionManager = require('../src/main/collaboration/permission-manager');
...
describe('Permission System', () => {
  ...
  beforeEach(() => {
    ...
    permissionMiddleware = new PermissionMiddleware(database, permissionManager);
  });
  ...
  describe('Permission Middleware', () => {
    describe('requirePermission', () => {
      it('should grant permission for owner role', async () => {
        ...
        const result = await middleware(null, { orgId: 'org1', userDID: 'did:user1' });
  ...
  describe('Permission Manager', () => {
    ...
    describe('getEffectivePermissions', () => {
      it('should return all permissions for owner', async () => {
        ...
        expect(permissions).toEqual(['view', 'edit', 'delete', 'share', 'manage']);
      });
  ...
  describe('Permission Caching', () => {
    it('should cache permission checks', async () => {
      ...
      // First check
      await permissionMiddleware.checkPermission('org1', 'did:user1', 'knowledge.view');
