...
describe('智能合约 IPC - 静态分析', () => {
  ...
  describe('合约条件和事件 Handlers', () => {
    ...
    it('should have 3 condition and event handlers', () => {
      const count = conditionHandlers.filter((h) => handlers.includes(h)).length;
      expect(count).toBe(3);
    });
  ...
  describe('仲裁功能 Handlers', () => {
    ...
    it('should have 2 arbitration handlers', () => {
      const count = arbitrationHandlers.filter((h) => handlers.includes(h)).length;
      expect(count).toBe(2);
    });
  ...
  describe('按功能域分类验证', () => {
    ...
    it('should group handlers correctly by functional domain', () => {
      const basicCount = handlers.filter((h) =>
        ['contract:create', 'contract:activate', 'contract:sign', 'contract:execute',
         'contract:cancel', 'contract:get', 'contract:get-list'].includes(h)
      ).length;
      const conditionCount = handlers.filter((h) =>
        ['contract:check-conditions', 'contract:get-conditions', 'contract:get-events'].includes(h)
      ).length;
      const arbitrationCount = handlers.filter((h) =>
        ['contract:initiate-arbitration', 'contract:resolve-arbitration'].includes(h)
      ).length;
      const templateCount = handlers.filter((h) =>
        ['contract:get-templates', 'contract:create-from-template', 'contract:get-blockchain-info'].includes(h)
      ).length;
...
describe('智能合约 IPC - 动态执行测试', () => {
  ...
  describe('contract:activate', () => {
    it('should activate contract successfully', async () => {
      ...
      const result = await handlers['contract:activate']({}, contractId);

      expect(mockContractEngine.activateContract).toHaveBeenCalledWith(contractId);
      expect(result).toEqual(mockResult);
    });
    ...
    it('should throw error when contractEngine is not initialized', async () => {
      ...
      await expect(
        handlers['contract:activate']({}, 'contract-1')
      ).rejects.toThrow('智能合约引擎未初始化');
    });
  ...
  describe('contract:sign', () => {
    it('should sign contract successfully', async () => {
      ...
      const result = await handlers['contract:sign']({}, contractId, signature);

      expect(mockContractEngine.signContract).toHaveBeenCalledWith(contractId, signature);
      expect(result).toEqual(mockResult);
    });
    ...
    it('should throw error when contractEngine is not initialized', async () => {
      ...
      await expect(
        handlers['contract:sign']({}, 'contract-1', 'sig')
      ).rejects.toThrow('智能合约引擎未初始化');
    });
  ...
  describe('contract:check-conditions', () => {
    it('should check conditions successfully', async () => {
      ...
      const result = await handlers['contract:check-conditions']({}, contractId);

      expect(mockContractEngine.checkConditions).toHaveBeenCalledWith(contractId);
      expect(result).toEqual(mockResult);
    });
    ...
    it('should return default value when contractEngine is not initialized', async () => {
      ...
      const result = await handlers['contract:check-conditions']({}, 'contract-1');
    ...
    it('should handle check conditions errors', async () => {
      ...
      await expect(
        handlers['contract:check-conditions']({}, 'contract-1')
  ...
  describe('contract:execute', () => {
    it('should execute contract successfully', async () => {
      ...
      const result = await handlers['contract:execute']({}, contractId);

      expect(mockContractEngine.executeContract).toHaveBeenCalledWith(contractId);
      expect(result).toEqual(mockResult);
    });
    ...
    it('should throw error when contractEngine is not initialized', async () => {
      ...
      await expect(
        handlers['contract:execute']({}, 'contract-1')
      ).rejects.toThrow('智能合约引擎未初始化');
    });
  ...
  describe('contract:cancel', () => {
    it('should cancel contract successfully', async () => {
      ...
      const result = await handlers['contract:cancel']({}, contractId, reason);

      expect(mockContractEngine.cancelContract).toHaveBeenCalledWith(contractId, reason);
      expect(result).toEqual(mockResult);
    });
    ...
    it('should throw error when contractEngine is not initialized', async () => {
      ...
      await expect(
        handlers['contract:cancel']({}, 'contract-1', 'reason')
      ).rejects.toThrow('智能合约引擎未初始化');
    });
  ...
  describe('contract:get', () => {
    it('should get contract successfully', async () => {
      const contractId = 'contract-1';
      const mockContract = { id: contractId, type: 'purchase', status: 'active' };

      mockContractEngine.getContract.mockResolvedValue(mockContract);

      const result = await handlers['contract:get']({}, contractId);
    ...
    it('should return null when contractEngine is not initialized', async () => {
      ...
      const result = await handlers['contract:get']({}, 'contract-1');
    ...
    it('should handle get contract errors', async () => {
      ...
      await expect(
        handlers['contract:get']({}, 'contract-1')
  ...
  describe('contract:get-list', () => {
    it('should get contract list successfully', async () => {
      ...
      const result = await handlers['contract:get-list']({}, filters);
    ...
    it('should return empty array when contractEngine is not initialized', async () => {
      ...
      const result = await handlers['contract:get-list']({}, {});
    ...
    it('should handle get list errors', async () => {
      ...
      await expect(
        handlers['contract:get-list']({}, {})
      ).rejects.toThrow('获取列表失败');
    });
  });
  ...
  describe('contract:get-conditions', () => {
    it('should get contract conditions successfully', async () => {
      ...
      mockContractEngine.getContractConditions.mockResolvedValue(mockConditions);

      const result = await handlers['contract:get-conditions']({}, contractId);

      expect(mockContractEngine.getContractConditions).toHaveBeenCalledWith(contractId);
    ...
    it('should return empty array when contractEngine is not initialized', async () => {
      ...
      const result = await handlers['contract:get-conditions']({}, 'contract-1');
    ...
    it('should handle get conditions errors', async () => {
      ...
      await expect(
        handlers['contract:get-conditions']({}, 'contract-1')
  ...
  describe('contract:get-events', () => {
    it('should get contract events successfully', async () => {
      ...
      const result = await handlers['contract:get-events']({}, contractId);

      expect(mockContractEngine.getContractEvents).toHaveBeenCalledWith(contractId);
    ...
    it('should return empty array when contractEngine is not initialized', async () => {
      ...
      const result = await handlers['contract:get-events']({}, 'contract-1');
    ...
    it('should handle get events errors', async () => {
      ...
      await expect(
        handlers['contract:get-events']({}, 'contract-1')
  ...
  describe('contract:initiate-arbitration', () => {
    it('should initiate arbitration successfully', async () => {
      ...
      const result = await handlers['contract:initiate-arbitration']({}, contractId, reason, evidence);

      expect(mockContractEngine.initiateArbitration).toHaveBeenCalledWith(contractId, reason, evidence);
      expect(result).toEqual(mockResult);
    });
    ...
    it('should throw error when contractEngine is not initialized', async () => {
      ...
      await expect(
        handlers['contract:initiate-arbitration']({}, 'contract-1', 'reason', [])
      ).rejects.toThrow('智能合约引擎未初始化');
    });
  ...
  describe('contract:resolve-arbitration', () => {
    it('should resolve arbitration successfully', async () => {
      ...
      const mockResult = { id: arbitrationId, status: 'resolved', ...resolution };

      mockContractEngine.resolveArbitration.mockResolvedValue(mockResult);

      const result = await handlers['contract:resolve-arbitration']({}, arbitrationId, resolution);

      expect(mockContractEngine.resolveArbitration).toHaveBeenCalledWith(arbitrationId, resolution);
      expect(result).toEqual(mockResult);
    });
    ...
    it('should throw error when contractEngine is not initialized', async () => {
      ...
      await expect(
        handlers['contract:resolve-arbitration']({}, 'arb-1', {})
      ).rejects.toThrow('智能合约引擎未初始化');
    });
  ...
  describe('contract:get-blockchain-info', () => {
    it('should get blockchain info successfully', async () => {
      ...
      const result = await handlers['contract:get-blockchain-info']({}, contractId);

      expect(mockContractEngine._getDeployedContract).toHaveBeenCalledWith(contractId);
    ...
    it('should return null when contractEngine is not initialized', async () => {
      ...
      const result = await handlers['contract:get-blockchain-info']({}, 'contract-1');
