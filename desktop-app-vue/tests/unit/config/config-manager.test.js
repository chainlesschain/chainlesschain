...
describe("ConfigManager", () => {
  ...
  describe("exportSkills()", () => {
    ...
    it("should include tools when includeTools is true", async () => {
      const result = await configManager.exportSkills(null, {
        includeTools: true,
      });
  ...
  describe("exportTools()", () => {
    ...
    it("should include stats when includeStats is true", async () => {
      const result = await configManager.exportTools(null, {
        includeStats: true,
      });
  ...
  describe("importConfig()", () => {
    it("should validate config data has version", async () => {
      ...
      await expect(configManager.importConfig(invalidData)).rejects.toThrow(
        "配置数据缺少版本信息",
      );
    });
