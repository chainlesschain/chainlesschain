...
describe("SystemCommandHandlerEnhanced", () => {
  ...
  describe("screenshot", () => {
    ...
    it("should handle screenshot library error", async () => {
      ...
      await expect(handler.screenshot({}, mockContext)).rejects.toThrow(
        "Screenshot failed",
      );
    });
  });
  ...
  describe("notify", () => {
    ...
    it("should reject missing title", async () => {
      ...
      await expect(handler.notify(params, mockContext)).rejects.toThrow(
  ...
  describe("execCommand", () => {
    ...
    it("should reject dangerous command (rm -rf)", async () => {
      ...
      await expect(handler.execCommand(params, mockContext)).rejects.toThrow(
        "Command not allowed",
      );
  ...
  describe("handle (unified entry)", () => {
    it("should route to correct method", async () => {
      const notifyResult = await handler.handle(
        "notify",
        {
          title: "Test",
          body: "Test body",
