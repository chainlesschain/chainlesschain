...
describe("ExtensionBrowserHandler", () => {
  ...
  describe("Touch Emulation Operations", () => {
    ...
    it("should handle emulateTap", async () => {
      ...
      expect(server.sendCommand).toHaveBeenCalledWith("client-1", "touch.tap", {
        tabId: 1,
        x: 100,
        y: 200,
      });
  ...
  describe("Viewport Management Operations", () => {
    ...
    it("should handle setViewportEmulation", async () => {
      await handler.handle(
    ...
    it("should handle getViewportInfo", async () => {
      await handler.handle("getViewportInfo", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "viewport.get",
        { tabId: 1 },
  ...
  describe("Web Workers Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });
    ...
    it("should handle terminateWorker", async () => {
      await handler.handle(
        "terminateWorker",
  ...
  describe("Broadcast Channel Operations", () => {
    ...
    it("should handle createBroadcastChannel", async () => {
      await handler.handle(
        "createBroadcastChannel",
        { tabId: 1, channelName: "my-channel" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle closeBroadcastChannel", async () => {
      await handler.handle(
  ...
  describe("Web Audio Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle getAudioContexts", async () => {
      await handler.handle("getAudioContexts", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "audio.getContexts",
        { tabId: 1 },
    ...
    it("should handle getAudioNodes", async () => {
      await handler.handle(
        "getAudioNodes",
    ...
    it("should handle suspendAudioContext", async () => {
      await handler.handle(
        "suspendAudioContext",
        { tabId: 1, contextId: "ctx-1" },
        {},
    ...
    it("should handle resumeAudioContext", async () => {
      await handler.handle(
        "resumeAudioContext",
        { tabId: 1, contextId: "ctx-1" },
        {},
  ...
  describe("Canvas/WebGL Operations", () => {
    ...
    it("should handle getWebGLInfo", async () => {
      await handler.handle(
        "getWebGLInfo",
    ...
    it("should handle getWebGLExtensions", async () => {
      await handler.handle(
        "getWebGLExtensions",
        { tabId: 1, selector: "#glCanvas" },
        {},
  ...
  describe("Media Devices Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle enumerateMediaDevices", async () => {
  ...
  describe("System Info Operations", () => {
    ...
    it("should handle getConnectionInfo", async () => {
    ...
    it("should handle getDeviceMemory", async () => {
  ...
  describe("Permissions Operations", () => {
    ...
    it("should handle queryPermission", async () => {
      await handler.handle(
        "queryPermission",
        { tabId: 1, permissionName: "geolocation" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Notifications Operations", () => {
    ...
    it("should handle getNotificationPermission", async () => {
      await handler.handle("getNotificationPermission", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Fullscreen Operations", () => {
    ...
    it("should handle exitFullscreen", async () => {
      await handler.handle("exitFullscreen", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "fullscreen.exit",
        { tabId: 1 },
  ...
  describe("Pointer Lock Operations", () => {
    ...
    it("should handle requestPointerLock", async () => {
      await handler.handle(
        "requestPointerLock",
        { tabId: 1, selector: "#game-canvas" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle exitPointerLock", async () => {
      await handler.handle("exitPointerLock", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "pointerLock.exit",
        { tabId: 1 },
  ...
  describe("Web Share API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle canShare", async () => {
      await handler.handle(
        "canShare",
        { tabId: 1, data: { title: "Test" } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle share", async () => {
      await handler.handle(
        "share",
        { tabId: 1, data: { title: "Test", url: "https://example.com" } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle shareFiles", async () => {
      await handler.handle(
        "shareFiles",
        {
          tabId: 1,
          files: [{ name: "test.txt", type: "text/plain", data: "dGVzdA==" }],
        },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
    ...
    it("should handle getShareTargets", async () => {
      await handler.handle("getShareTargets", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Credential Management API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle getCredential", async () => {
      await handler.handle(
        "getCredential",
        { tabId: 1, options: { password: true } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle storeCredential", async () => {
      await handler.handle(
        "storeCredential",
        { tabId: 1, credential: { id: "user", password: "pass" } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle createCredential", async () => {
      await handler.handle("createCredential", { tabId: 1, options: {} }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "credential.create",
        { tabId: 1, options: {} },
    ...
    it("should handle preventSilentAccess", async () => {
      await handler.handle("preventSilentAccess", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle isConditionalMediationAvailable", async () => {
      await handler.handle("isConditionalMediationAvailable", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getPublicKeyCredential", async () => {
      await handler.handle(
        "getPublicKeyCredential",
        { tabId: 1, options: { publicKey: { challenge: [1, 2, 3] } } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Screen Wake Lock API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle requestWakeLock", async () => {
      await handler.handle("requestWakeLock", { tabId: 1, type: "screen" }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "wakeLock.request",
        { tabId: 1, type: "screen" },
    ...
    it("should handle releaseWakeLock", async () => {
      await handler.handle("releaseWakeLock", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "wakeLock.release",
        { tabId: 1 },
    ...
    it("should handle getWakeLockState", async () => {
      await handler.handle("getWakeLockState", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "wakeLock.getState",
        { tabId: 1 },
    ...
    it("should handle isWakeLockSupported", async () => {
      await handler.handle("isWakeLockSupported", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("File System Access API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle showOpenFilePicker", async () => {
      await handler.handle(
        "showOpenFilePicker",
        { tabId: 1, options: { multiple: true } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle showSaveFilePicker", async () => {
      await handler.handle(
        "showSaveFilePicker",
        { tabId: 1, options: { suggestedName: "file.txt" } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle showDirectoryPicker", async () => {
      await handler.handle(
        "showDirectoryPicker",
        { tabId: 1, options: {} },
        {},
    ...
    it("should handle getFileSystemHandle", async () => {
      await handler.handle(
        "getFileSystemHandle",
        { tabId: 1, name: "test.txt", options: {} },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle readFileFromHandle", async () => {
      await handler.handle(
        "readFileFromHandle",
        { tabId: 1, handleId: "fh_123" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle writeFileToHandle", async () => {
      await handler.handle(
        "writeFileToHandle",
        { tabId: 1, handleId: "fh_123", content: "Hello" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getFileHandleInfo", async () => {
      await handler.handle(
        "getFileHandleInfo",
        { tabId: 1, handleId: "fh_123" },
        {},
    ...
    it("should handle removeFileEntry", async () => {
      await handler.handle(
        "removeFileEntry",
        { tabId: 1, handleId: "fh_123", options: { recursive: true } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Tab Groups API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle createTabGroup", async () => {
      await handler.handle(
        "createTabGroup",
        { tabIds: [1, 2, 3], options: { title: "Research" } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getTabGroup", async () => {
      await handler.handle("getTabGroup", { groupId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "tabGroups.get",
        { groupId: 1 },
    ...
    it("should handle getAllTabGroups", async () => {
      await handler.handle("getAllTabGroups", { windowId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "tabGroups.getAll",
        { windowId: 1 },
    ...
    it("should handle updateTabGroup", async () => {
      await handler.handle(
        "updateTabGroup",
        { groupId: 1, options: { title: "Updated", color: "blue" } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle moveTabGroup", async () => {
      await handler.handle(
        "moveTabGroup",
        { groupId: 1, moveProperties: { windowId: 2, index: 0 } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle ungroupTabs", async () => {
      await handler.handle("ungroupTabs", { tabIds: [1, 2, 3] }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "tabGroups.ungroup",
        { tabIds: [1, 2, 3] },
  ...
  describe("Eye Dropper API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle openEyeDropper", async () => {
      await handler.handle("openEyeDropper", { tabId: 1, options: {} }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "eyeDropper.open",
        { tabId: 1, options: {} },
    ...
    it("should handle isEyeDropperSupported", async () => {
      await handler.handle("isEyeDropperSupported", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Speech Synthesis API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle speak", async () => {
      await handler.handle(
        "speak",
        { tabId: 1, text: "Hello", options: { lang: "en-US" } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle cancelSpeech", async () => {
      await handler.handle("cancelSpeech", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "speech.cancel",
        { tabId: 1 },
    ...
    it("should handle pauseSpeech", async () => {
      await handler.handle("pauseSpeech", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "speech.pause",
        { tabId: 1 },
    ...
    it("should handle resumeSpeech", async () => {
      await handler.handle("resumeSpeech", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "speech.resume",
        { tabId: 1 },
    ...
    it("should handle getVoices", async () => {
      await handler.handle("getVoices", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "speech.getVoices",
        { tabId: 1 },
    ...
    it("should handle isSpeaking", async () => {
      await handler.handle("isSpeaking", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "speech.isSpeaking",
        { tabId: 1 },
    ...
    it("should handle isSpeechPending", async () => {
      await handler.handle("isSpeechPending", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "speech.isPending",
        { tabId: 1 },
    ...
    it("should handle isSpeechPaused", async () => {
      await handler.handle("isSpeechPaused", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "speech.isPaused",
        { tabId: 1 },
  ...
  describe("Background Sync API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle registerBackgroundSync", async () => {
      await handler.handle(
        "registerBackgroundSync",
        { tabId: 1, tag: "sync-data" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getBackgroundSyncTags", async () => {
      await handler.handle("getBackgroundSyncTags", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getBackgroundSyncRegistration", async () => {
      await handler.handle(
        "getBackgroundSyncRegistration",
        { tabId: 1, tag: "sync-data" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
    ...
    it("should handle getBackgroundSyncRegistrations", async () => {
      await handler.handle("getBackgroundSyncRegistrations", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Periodic Background Sync API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle registerPeriodicSync", async () => {
      await handler.handle(
        "registerPeriodicSync",
        { tabId: 1, tag: "periodic-sync", options: { minInterval: 86400000 } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle unregisterPeriodicSync", async () => {
      await handler.handle(
        "unregisterPeriodicSync",
        { tabId: 1, tag: "periodic-sync" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getPeriodicSyncTags", async () => {
      await handler.handle("getPeriodicSyncTags", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getPeriodicSyncMinInterval", async () => {
      await handler.handle("getPeriodicSyncMinInterval", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Idle Detection API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle requestIdleDetectionPermission", async () => {
      await handler.handle("requestIdleDetectionPermission", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle startIdleDetection", async () => {
      await handler.handle(
        "startIdleDetection",
        { tabId: 1, threshold: 60000 },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle stopIdleDetection", async () => {
      await handler.handle("stopIdleDetection", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith("client-1", "idle.stop", {
        tabId: 1,
      });
    });

    it("should handle getIdleState", async () => {
      await handler.handle("getIdleState", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "idle.getState",
        { tabId: 1 },
  ...
  describe("Device Memory API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle getNavigatorDeviceMemory", async () => {
      await handler.handle("getNavigatorDeviceMemory", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "deviceMemory.get",
        { tabId: 1 },
  ...
  describe("Network Information API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle getNetworkInformation", async () => {
      await handler.handle("getNetworkInformation", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "networkInfo.get",
        { tabId: 1 },
    ...
    it("should handle onNetworkChange", async () => {
      await handler.handle("onNetworkChange", { tabId: 1, enable: true }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Vibration API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle vibrate", async () => {
      await handler.handle(
        "vibrate",
        { tabId: 1, pattern: [200, 100, 200] },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle cancelVibration", async () => {
      await handler.handle("cancelVibration", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "vibration.cancel",
        { tabId: 1 },
  ...
  describe("Screen Orientation API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle getScreenOrientation", async () => {
      await handler.handle("getScreenOrientation", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "orientation.get",
        { tabId: 1 },
    ...
    it("should handle lockScreenOrientation", async () => {
      await handler.handle(
        "lockScreenOrientation",
        { tabId: 1, orientation: "landscape" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle unlockScreenOrientation", async () => {
      await handler.handle("unlockScreenOrientation", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "orientation.unlock",
        { tabId: 1 },
  ...
  describe("Presentation API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle getPresentationAvailability", async () => {
      await handler.handle(
        "getPresentationAvailability",
        { tabId: 1, urls: ["https://example.com/presentation"] },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle startPresentation", async () => {
      await handler.handle(
        "startPresentation",
        { tabId: 1, urls: ["https://example.com/presentation"] },
        {},
    ...
    it("should handle reconnectPresentation", async () => {
      await handler.handle(
        "reconnectPresentation",
        { tabId: 1, presentationId: "pres-123" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getPresentationConnections", async () => {
      await handler.handle("getPresentationConnections", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle terminatePresentation", async () => {
      await handler.handle(
        "terminatePresentation",
        { tabId: 1, connectionId: "conn-123" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Reporting API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle getReports", async () => {
      await handler.handle(
        "getReports",
        { tabId: 1, types: ["deprecation", "intervention"] },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle clearReports", async () => {
      await handler.handle("clearReports", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Web Bluetooth API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle requestBluetoothDevice", async () => {
      await handler.handle(
        "requestBluetoothDevice",
        { tabId: 1, options: { filters: [{ services: ["battery_service"] }] } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getBluetoothDevices", async () => {
      await handler.handle("getBluetoothDevices", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getBluetoothAvailability", async () => {
      await handler.handle("getBluetoothAvailability", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle connectBluetoothDevice", async () => {
      await handler.handle(
        "connectBluetoothDevice",
        { tabId: 1, deviceId: "dev-1" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle disconnectBluetoothDevice", async () => {
      await handler.handle(
    ...
    it("should handle getBluetoothServices", async () => {
      await handler.handle(
  ...
  describe("Web USB API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle requestUSBDevice", async () => {
      await handler.handle(
        "requestUSBDevice",
        { tabId: 1, options: { filters: [{ vendorId: 0x1234 }] } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getUSBDevices", async () => {
      await handler.handle("getUSBDevices", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "usb.getDevices",
        { tabId: 1 },
    ...
    it("should handle openUSBDevice", async () => {
      await handler.handle(
        "openUSBDevice",
        { tabId: 1, deviceId: "usb_1" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith("client-1", "usb.open", {
        tabId: 1,
        deviceId: "usb_1",
      });
    });

    it("should handle closeUSBDevice", async () => {
      await handler.handle(
        "closeUSBDevice",
        { tabId: 1, deviceId: "usb_1" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith("client-1", "usb.close", {
        tabId: 1,
        deviceId: "usb_1",
      });
    });

    it("should handle selectUSBConfiguration", async () => {
      await handler.handle(
        "selectUSBConfiguration",
        { tabId: 1, deviceId: "usb_1", configurationValue: 1 },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle claimUSBInterface", async () => {
      await handler.handle(
        "claimUSBInterface",
        { tabId: 1, deviceId: "usb_1", interfaceNumber: 0 },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Web Serial API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle requestSerialPort", async () => {
      await handler.handle("requestSerialPort", { tabId: 1, options: {} }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "serial.requestPort",
        { tabId: 1, options: {} },
    ...
    it("should handle getSerialPorts", async () => {
      await handler.handle("getSerialPorts", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "serial.getPorts",
        { tabId: 1 },
    ...
    it("should handle openSerialPort", async () => {
      await handler.handle(
        "openSerialPort",
        { tabId: 1, portId: "serial_1", options: { baudRate: 9600 } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle closeSerialPort", async () => {
      await handler.handle(
        "closeSerialPort",
        { tabId: 1, portId: "serial_1" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle readSerialPort", async () => {
      await handler.handle(
        "readSerialPort",
        { tabId: 1, portId: "serial_1", length: 100 },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle writeSerialPort", async () => {
      await handler.handle(
        "writeSerialPort",
        { tabId: 1, portId: "serial_1", data: [0x48, 0x65, 0x6c, 0x6c, 0x6f] },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Gamepad API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle getGamepads", async () => {
      await handler.handle("getGamepads", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "gamepad.getGamepads",
        { tabId: 1 },
    ...
    it("should handle getGamepadState", async () => {
      await handler.handle("getGamepadState", { tabId: 1, index: 0 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "gamepad.getState",
        { tabId: 1, index: 0 },
    ...
    it("should handle vibrateGamepad", async () => {
      await handler.handle(
        "vibrateGamepad",
        { tabId: 1, index: 0, options: { duration: 200 } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle isGamepadSupported", async () => {
      await handler.handle("isGamepadSupported", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "gamepad.isSupported",
        { tabId: 1 },
  ...
  describe("Web MIDI API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle requestMIDIAccess", async () => {
      await handler.handle(
        "requestMIDIAccess",
        { tabId: 1, options: { sysex: true } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getMIDIInputs", async () => {
      await handler.handle("getMIDIInputs", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "midi.getInputs",
        { tabId: 1 },
    ...
    it("should handle getMIDIOutputs", async () => {
      await handler.handle("getMIDIOutputs", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "midi.getOutputs",
        { tabId: 1 },
    ...
    it("should handle sendMIDIMessage", async () => {
      await handler.handle(
        "sendMIDIMessage",
        { tabId: 1, outputId: "output-1", data: [0x90, 60, 100] },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith("client-1", "midi.send", {
        tabId: 1,
        outputId: "output-1",
        data: [0x90, 60, 100],
      });
    ...
    it("should handle closeMIDIAccess", async () => {
      await handler.handle("closeMIDIAccess", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "midi.close",
        { tabId: 1 },
  ...
  describe("Picture-in-Picture API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle requestPictureInPicture", async () => {
      await handler.handle(
    ...
    it("should handle exitPictureInPicture", async () => {
      await handler.handle("exitPictureInPicture", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith("client-1", "pip.exit", {
        tabId: 1,
      });
    });

    it("should handle getPictureInPictureWindow", async () => {
      await handler.handle("getPictureInPictureWindow", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "pip.getWindow",
        { tabId: 1 },
    ...
    it("should handle isPictureInPictureEnabled", async () => {
      await handler.handle("isPictureInPictureEnabled", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "pip.isEnabled",
        { tabId: 1 },
    ...
    it("should handle isPictureInPictureSupported", async () => {
      await handler.handle("isPictureInPictureSupported", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "pip.isSupported",
        { tabId: 1 },
  ...
  describe("Document Picture-in-Picture API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle requestDocumentPictureInPicture", async () => {
      await handler.handle(
        "requestDocumentPictureInPicture",
        { tabId: 1, options: { width: 400, height: 300 } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getDocumentPictureInPictureWindow", async () => {
      await handler.handle(
  ...
  describe("Web Locks API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle requestLock", async () => {
      await handler.handle(
        "requestLock",
        { tabId: 1, name: "my-lock", options: { mode: "exclusive" } },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle queryLocks", async () => {
      await handler.handle("queryLocks", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "locks.query",
        { tabId: 1 },
    ...
    it("should handle releaseLock", async () => {
      await handler.handle("releaseLock", { tabId: 1, name: "my-lock" }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "locks.release",
        { tabId: 1, name: "my-lock" },
      );
    });

    it("should handle isLocksSupported", async () => {
      await handler.handle("isLocksSupported", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "locks.isSupported",
        { tabId: 1 },
  ...
  describe("Badging API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle setBadge", async () => {
      await handler.handle("setBadge", { tabId: 1, contents: 5 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith("client-1", "badge.set", {
        tabId: 1,
        contents: 5,
      });
    });

    it("should handle clearBadge", async () => {
      await handler.handle("clearBadge", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "badge.clear",
        { tabId: 1 },
    ...
    it("should handle isBadgeSupported", async () => {
      await handler.handle("isBadgeSupported", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "badge.isSupported",
        { tabId: 1 },
  ...
  describe("Local Font Access API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle queryLocalFonts", async () => {
      await handler.handle("queryLocalFonts", { tabId: 1, options: {} }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "fonts.query",
        { tabId: 1, options: {} },
    ...
    it("should handle getFontPostscriptNames", async () => {
      await handler.handle("getFontPostscriptNames", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle isLocalFontsSupported", async () => {
      await handler.handle("isLocalFontsSupported", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "fonts.isSupported",
        { tabId: 1 },
  ...
  describe("Window Management API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle getScreenDetails", async () => {
      await handler.handle("getScreenDetails", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "screens.getScreens",
        { tabId: 1 },
    ...
    it("should handle getCurrentScreen", async () => {
      await handler.handle("getCurrentScreen", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle isMultiScreenEnvironment", async () => {
      await handler.handle("isMultiScreenEnvironment", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle requestScreensPermission", async () => {
      await handler.handle("requestScreensPermission", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
    ...
    it("should handle getScreenById", async () => {
      await handler.handle(
        "getScreenById",
        { tabId: 1, screenId: "screen-1" },
        {},
      );
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
  ...
  describe("Compute Pressure API Operations", () => {
    beforeEach(() => {
      server.clients.set("client-1", { ws: { readyState: 1 } });
      vi.spyOn(server, "sendCommand").mockResolvedValue({ success: true });
    });

    it("should handle observeComputePressure", async () => {
      await handler.handle(
    ...
    it("should handle unobserveComputePressure", async () => {
      await handler.handle("unobserveComputePressure", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "pressure.unobserve",
        { tabId: 1 },
    ...
    it("should handle getComputePressureState", async () => {
      await handler.handle("getComputePressureState", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
        "pressure.getState",
        { tabId: 1 },
    ...
    it("should handle isComputePressureSupported", async () => {
      await handler.handle("isComputePressureSupported", { tabId: 1 }, {});
      expect(server.sendCommand).toHaveBeenCalledWith(
        "client-1",
