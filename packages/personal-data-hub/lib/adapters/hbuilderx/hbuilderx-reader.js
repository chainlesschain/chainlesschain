...
const DEFAULT_MAX_ROOTS = HARD_MAX_ROOTS;
...
const DEFAULT_MAX_SECTIONS = HARD_MAX_SECTIONS;
const HARD_MAX_LINE_CHARS = 64 * 1024;
const DEFAULT_MAX_LINE_CHARS = HARD_MAX_LINE_CHARS;
const HARD_MAX_RECORDS = 100_000;
const DEFAULT_MAX_RECORDS = HARD_MAX_RECORDS;
