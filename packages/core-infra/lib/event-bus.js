 ...
 * Cross-module event bus (replaces ipcMain abuse for inter-module comms)
 *
 * Extracted from desktop-app-vue/src/main/core/event-bus.js
 */
...
class EventBus extends EventEmitter {
  ...
  unsubscribe(subscriptionId) {
    for (const [_channel, subs] of this._channels) {
