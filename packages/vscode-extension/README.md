...
> [0.37.80 VSIX directly](https://open-vsx.org/api/chainlesschain/chainlesschain-ide/0.37.80/file/chainlesschain.chainlesschain-ide-0.37.80.vsix)
...
Version `0.37.80` also consumes only strict, CLI-issued multi-agent merge-review
...
[`ide-vscode-v0.37.80`](https://github.com/chainlesschain/chainlesschain/releases/tag/ide-vscode-v0.37.80).
...
- In stock Microsoft VS Code, do not click Open VSX's generic **Install** link.
  Download the [versioned `.vsix`](https://open-vsx.org/api/chainlesschain/chainlesschain-ide/0.37.80/file/chainlesschain.chainlesschain-ide-0.37.80.vsix)
...
node scripts/verify-vsix.mjs chainlesschain-ide-0.37.80.vsix
```
