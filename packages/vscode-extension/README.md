...
> Extension candidate `0.37.90` pairs with `chainlesschain@0.166.34` for reliable web fetch
...
Source candidate `0.37.90` adds recoverable Evolution Workbench connections and
complete version-history validation. It awaits the release gates; the versioned
download links below become available only after publication.

| Component                 | Current status                                               |
| ------------------------- | ------------------------------------------------------------ |
| VS Code extension         | **0.37.90**; Workbench recovery candidate                    |
...
> [0.37.90 VSIX directly (available only after extension publication)](https://open-vsx.org/api/chainlesschain/chainlesschain-ide/0.37.90/file/chainlesschain.chainlesschain-ide-0.37.90.vsix)
...
and shared permission/budget enforcement. Version `0.37.90` accepts only the
...
Version `0.37.90` also consumes only strict, CLI-issued multi-agent merge-review
...
`0.37.90`. The extension continues to fail closed when an older CLI cannot
...
[`ide-vscode-v0.37.90`](https://github.com/chainlesschain/chainlesschain/releases/tag/ide-vscode-v0.37.90).
...
- In stock Microsoft VS Code, do not click Open VSX's generic **Install** link.
  Download the [versioned `.vsix`](https://open-vsx.org/api/chainlesschain/chainlesschain-ide/0.37.90/file/chainlesschain.chainlesschain-ide-0.37.90.vsix)
...
node scripts/verify-vsix.mjs chainlesschain-ide-0.37.90.vsix
```
