      ...
      >
        <template v-if="!collapsed">
          ...
          <a-sub-menu key="g-data">
            ...
            <a-menu-item key="artifacts"><template #icon><FileDoneOutlined /></template>交付物</a-menu-item>
          </a-sub-menu>
          <a-sub-menu key="g-advanced">
            ...
            <a-menu-item key="multisig"><template #icon><TeamOutlined /></template>{{ $t('appLayout.items.multisig', 'M-of-N 多签') }}</a-menu-item>
            ...
            <a-menu-item key="remote-session"><template #icon><DesktopOutlined /></template>{{ $t('appLayout.items.remoteSession', '远程会话') }}</a-menu-item>
            <a-menu-item key="mobile-projects"><template #icon><MobileOutlined /></template>{{ $t('appLayout.items.mobileProjects', '手机项目 (v0.2)') }}</a-menu-item>
            <a-menu-item key="terminal"><template #icon><DesktopOutlined /></template>{{ $t('appLayout.items.terminal', '远程终端') }}</a-menu-item>
        ...
        <template v-else>
          ...
          <a-menu-item key="artifacts"><template #icon><FileDoneOutlined /></template></a-menu-item>
          <a-menu-divider class="divider-sm" />
          ...
          <a-menu-item key="multisig"><template #icon><TeamOutlined /></template></a-menu-item>
          ...
          <a-menu-item key="terminal"><template #icon><DesktopOutlined /></template></a-menu-item>
