...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'quick-ask',  name: 'QuickAsk',    component: () => import('../views/QuickAsk.vue') },
      { path: 'ukey-sign',  name: 'UkeySign',    component: () => import('../views/UkeySign.vue') },
      ...
      { path: 'personal-data-hub/browser', name: 'PdhVaultBrowser', component: () => import('../views/PdhVaultBrowser.vue') },
      { path: 'family-guard', name: 'FamilyGuardDashboard', component: () => import('../views/FamilyGuardDashboard.vue') },
      ...
      { path: 'remote-session', name: 'RemoteSession', component: () => import('../views/RemoteSession.vue') },
