...
describe("cc mtc batch --federation — Phase 3.2 marketplace federation", () => {
  ...
  it(
    "3-of-3 Ed25519 federation produces a verifiable landmark",
    { timeout: 180_000 },
    () => {
  ...
  it(
    "2-of-3 threshold accepts when one member's sig is tampered",
    { timeout: 180_000 },
    () => {
  ...
  it(
    "mixed Ed25519 + SLH-DSA federation members produce a heterogeneous landmark",
    { timeout: 180_000 },
    () => {
      runCli([
        "mtc",
