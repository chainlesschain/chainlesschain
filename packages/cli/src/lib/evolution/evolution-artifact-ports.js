...
const LEDGER_RETENTION_PURPOSES_BY_TYPE = new Map([
  ...
  ["evolution-workbench-projection", new Set(["evolution-ledger"])],
  ["evolution-workbench-review-preparation", new Set(["evolution-ledger"])],
  ["evolution-workbench-review-settlement", new Set(["evolution-ledger"])],
  ["evolution-workbench-rollback-preparation", new Set(["evolution-ledger"])],
  ["evolution-workbench-rollback-settlement", new Set(["evolution-ledger"])],
  ...
  ["skill-runtime-revalidation-state", new Set(["evolution-ledger"])],
  ["evolution-ledger-v2-journal", new Set(["evolution-ledger"])],
  ...
  ["governed-skill-synthesis-evaluation", new Set(["evolution-ledger"])],
