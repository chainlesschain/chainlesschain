...
export function reduceGraphTrace(
  ...
  const projection = {
    ...
    originSurface: state.authority?.originSurface || null,
    authoritySource: state.authority?.authoritySource || null,
    authorityMode: state.authority?.authorityMode || null,
    authorityGeneration: state.authority?.authorityGeneration || null,
    writerId: state.authority?.writerId || null,
    projectionVersion: state.authority?.projectionVersion || null,
