...
| Desktop Renderer | 113 Pinia stores、Shell 骨架、Artifact 面板                         |
| CLI              | 169 命令（单进程 / Skill / MCP 桥）                                 |
| Java Backend     | RBAC / SSO / 合规审计 / 项目管理                                    |
| Python AI        | Ollama 推理、Qdrant 向量、RAG                                       |
| Android          | 25 REMOTE Skills（SeedRegistry，v1.0 GA 后架构重新定位为纯 REMOTE） |
...
- **113 Pinia stores**：每个域一个 store，773+ 专项测试（26 测试文件）
