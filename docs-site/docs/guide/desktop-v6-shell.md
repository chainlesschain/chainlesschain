...
```json
{
  ...
  "plugins": {
    "trustedPublicKeys": ["ed25519:BASE64-PUBLIC-KEY-OF-COMPANY"],
...
- `handlers/skill-list-handler.js` — 桌面 SkillToolSystem 暴露 `skill.list`，让 web-panel `stores/skills.js` 拉到桌面态的 141 内置技能。
