...
features:
  ...
  - icon: 📱
    title: iOS 完整移植 (Phase 1+2+3 · NEW)
    details: 镜像 Android 三 Phase 框架级落地 — 桌面配对三流 + 远程桌面终端 (xterm.js WKWebView) + 远程操控 5-tab segmented shell (Clipboard/File/Screenshot/SystemInfo)。SwiftUI + Swift Concurrency + Google WebRTC SDK，~264 单测，待真机 E2E。
  - icon: 🧪
    title: 工程化验证
