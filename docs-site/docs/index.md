...
hero:
  name: ChainlessChain
  text: 去中心化个人AI管理平台
  tagline: v0.37.6 | 军事级安全 | 完全去中心化 | AI原生 | 90技能 | 统一工具注册表
  image:
    src: /logo.png
...
features:
  ...
  - icon: 🎨
    title: AI技能系统
    details: 90个内置技能，Agent Skills开放标准，统一工具注册表(60+工具+8 MCP+90技能)，10个演示模板
...
完全去中心化的个人AI助手平台（v0.37.6 AI技能系统），整合知识库管理、社交网络和交易辅助三大核心功能。
...
- 📱 跨设备同步 (PC/移动端/浏览器扩展)
- 🔌 MCP集成 + 90内置技能 + 统一工具注册表
- 🎨 AI技能系统 (90技能 + Agent Skills标准 + 10演示模板)
- ⛓️ 区块链集成 (15链 + 6个智能合约)
