...
> **版本: v0.36.0 | 15内置技能 | Agent Skills开放标准 | 统一工具注册表**

Skills 系统提供 15 个内置技能，使用 Markdown 定义技能(SKILL.md)，支持四层加载、Agent Skills 开放标准(13扩展字段)、门控检查和自定义命令。v0.36.0 新增统一工具注册表，聚合三大工具系统。
