...
> **版本: v0.37.3 | 60内置技能 | Agent Skills开放标准 | 统一工具注册表**

Skills 系统提供 60 个内置技能，使用 Markdown 定义技能(SKILL.md)，支持四层加载、Agent Skills 开放标准(13扩展字段)、门控检查和自定义命令。v0.37.3 新增 10 个 Office文档 + 音视频处理技能（pdf-toolkit、doc-converter、excel-analyzer、pptx-creator、doc-comparator、audio-transcriber、video-toolkit、subtitle-generator、tts-synthesizer、media-metadata），Handler 覆盖率 60/60 (100%)。
...
marketplace/   # 插件市场安装的技能 (v0.34.0新增)
    ↓
bundled/       # 内置技能（60个，100% Handler覆盖，最低优先级）
```
