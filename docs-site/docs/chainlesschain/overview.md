...
> **当前版本: v5.0.3.104 进化版 | 145 桌面技能 + 25 Android 技能 | CLI v0.162.37 / 155 命令 / 30,000+ 测试 | Android 5.0.3.104 (versionCode 503104，与 productVersion 对齐 · USR_VERSION 20 · binariesVersion 待 cc-cli.tgz 重建) | iOS 5.0.3 (build 104，ad-hoc 签名 .ipa)**
>
...
ChainlessChain 是一个完全去中心化的个人 AI 管理系统，整合知识库管理、去中心化社交和交易辅助三大核心功能。系统通过 U-Key/SIMKey 硬件加密和本地 AI 模型提供军事级隐私保护，支持 145 个桌面内置技能、25 个 Android REMOTE 技能、155 个 CLI 命令以及 14+ 云端 LLM 和本地 Ollama 模型集成。
...
- 🤖 **AI 智能引擎**: 16 个专用引擎 + 145 内置技能 + 14+ 云 LLM + Ollama 本地模型 + Cowork 多智能体 + AI Orchestration编排
...
┌───────────────────▼─────────────────────────┐
│              AI 智能层                        │
│  Cowork多Agent │ Skills(145) │ Plan Mode    │
...
| AI专用引擎  | 16个                                    |
| 内置技能    | 145个                                   |
| 统一工具    | 60+ FunctionCaller + 8 MCP + 145 Skills |
| Pinia Store | 99个                                    |
| 数据库表    | 95+张                                   |
| CLI命令     | 112个                                   |
...
- 🧩 **技能系统**: 145个内置技能，Agent Skills开放标准，四层加载架构
...
可扩展的技能框架，145个内置技能覆盖开发、文档、安全、媒体等全场景。
...
- ✅ Cowork协作演化技能 (debate-review, ab-compare, orchestrate, verification-loop, stream-processor, 共145个内置技能)
...
- [AI技能系统](/chainlesschain/skills) - 145个内置技能
...
| 测试文件                                                                           | 覆盖范围                                        |
| ---------------------------------------------------------------------------------- | ----------------------------------------------- |
| ✅ `desktop-app-vue/tests/unit/ai-engine/skill-handlers.test.js`                   | 145 技能 Handler 端到端（200+ tests）           |
...
- [AI 技能系统](/chainlesschain/skills) - 145 个内置技能完整列表
