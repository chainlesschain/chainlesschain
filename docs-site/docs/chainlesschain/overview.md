...
> **当前版本: v5.0.2.54 进化版 | 141桌面技能 + 28 Android技能 | CLI v0.156.7 / 109 命令 / 14800+ 测试 | V6 Chat-First 桌面壳（P0–P9c 全量落地）| CLI V2 规范层 220+ 治理表面（iter16–iter28 · ~5,984 V2 测试）| cc pack 多平台打包（macOS / Windows / Linux + 项目模式 Phase 2a/2b/3a/3b + OTA check-update / SHA-256 / 自替换）**

## 概述

ChainlessChain 是一个完全去中心化的个人 AI 管理系统，整合知识库管理、去中心化社交和交易辅助三大核心功能。系统通过 U-Key/SIMKey 硬件加密和本地 AI 模型提供军事级隐私保护，支持 141 个桌面内置技能、28 个 Android 技能、109 个 CLI 命令以及 14+ 云端 LLM 和本地 Ollama 模型集成。
...
| 数据库表    | 95+张                                   |
| CLI命令     | 109个                                   |
| CLI版本     | v0.156.7（CLI V2 治理浪潮 iter16–iter28：220+ 治理表面 / ~5,984 V2 测试 / 1,965 回归测试零失败；cc pack 项目模式 + macOS/Windows/Linux 多平台打包） |
| 钩子事件    | 32个 (4种类型)                          |
| 开发阶段    | Phase 1-102 完成                        |
