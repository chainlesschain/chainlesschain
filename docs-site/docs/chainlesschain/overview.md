...
> **当前版本: v3.4.0 企业版 | 128桌面技能 + 28 Android技能 | 77 Phase | 全栈智能化**
...
| AI专用引擎  | 16个                                    |
| 内置技能    | 128个                                   |
| 统一工具    | 60+ FunctionCaller + 8 MCP + 128 Skills |
| 演示模板    | 10个                                    |
| 浏览器命令  | 215个                                   |
| 数据库表    | 70+                                     |
| Pinia Store | 64个                                    |
...
- 🧩 **技能系统**: 128个内置技能，Agent Skills开放标准，四层加载架构
...
可扩展的技能框架，128个内置技能覆盖开发、文档、安全、媒体等全场景。
...
- ✅ Cowork协作演化技能 (debate-review, ab-compare, orchestrate, verification-loop, stream-processor, 共128个内置技能)
...
- [AI技能系统](/chainlesschain/skills) - 128个内置技能
