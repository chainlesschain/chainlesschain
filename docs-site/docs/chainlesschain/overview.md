...
> **当前版本（2026-09-04）：v5.0.3.135 | Agent Platform CLI 0.166.21（npm latest / 生产推荐）| Agent SDK TS/Python 0.2.8 | Agent Protocol 0.1.8 | Session Core 0.3.11 | PDH 0.4.59（92 个采集契约 / 18 类来源）| Open VSX 0.37.81 | JetBrains Marketplace 0.4.110 | Android versionCode 503135 | iOS build 135**
>
> **当前能力与发布边界**：`0.166.21@1ff70b7856` 已公开 Evolution Workbench、摘要绑定 Skill Retrieval，以及受治理加密知识冲突审核/合并，并把相同投影带到 Desktop、VS Code 与 JetBrains。客户端仍不能直写 active Skill 或 canonical knowledge；状态变更要求 trusted deployment host、精确 revision/digest、策略和持久账本，缺少生产 KMS/PKI/witness/grader 时失败闭合。
>
