...
> **版本: Design Module 98（机制篇，更新 2026-08-01）| 状态: ✅ 七 Phase 全落地 + 双公开渠道上架（VS Code `0.37.37` Open VSX / JetBrains `0.4.76` Marketplace）| 9+ IDE 工具 + Chat 面板 + 实时感知 | 跨语言 interop 实证**
>
> Open VSX 与 JetBrains Marketplace 均已公开上述版本；微软 VS Code Marketplace 仍未发布。当前日常使用、Agent Team human-control 与发布证据见 [IDE 插件使用指南](/chainlesschain/ide-plugin)。
>
...
cc --version          # 当前推荐 0.162.189；该桥接路径最低 0.162.39
