...
> **适用版本：CLI 0.166.15（npm latest、生产推荐一致，精确 SHA `22db04f559`）| Context/Memory、Hooks v2、P0 执行安全与 durable Graph 已公开 | Cowork Cron 接入统一 Scheduler Kernel、IANA 时区与 missed-run collapse | P2-16 Agent Teams 发布门已通过**
>
