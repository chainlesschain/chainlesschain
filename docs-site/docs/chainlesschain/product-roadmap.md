...
> **历史规划快照（2026-02-27）**：本文保留当时的 v1.1.0-alpha 企业版、Cowork v3.3/v4.0 与 SIMKey v0.39.0 路线，不代表当前已发布版本或能力清单。当前产品发布基线为 `v5.0.3.135`，生产推荐 CLI 为 `0.166.21`；下方配置和性能数字均为规划示例，不是当前运行时接受的配置 schema 或生产 SLA。
