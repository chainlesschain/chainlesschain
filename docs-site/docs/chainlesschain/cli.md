...
> **当前版本边界（2026-08-04）：产品 v5.0.3.135 / 推荐 CLI 0.162.189（完整门禁）/ npm latest 0.162.193（发布审查中）/ 源码候选 0.162.194 | 175 命令 | Node.js ≥ 22.12.0**
...
```bash
npm install -g chainlesschain@0.162.189
