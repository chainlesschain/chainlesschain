...
## [5.0.2.10 / CLI 0.129.0] - 2026-04-18 晚 (V2 第六批 · 13 个运行时管家)
...
- **CLI 包版本**：`chainlesschain@0.106.0 → 0.129.0`（V2 第六批一次性推进 13 个管家 + 小版本收口）
- **README**：中/英双语在最新版本区前插入 V2 第六批条目，替换安装命令到 `chainlesschain@0.129.0`
