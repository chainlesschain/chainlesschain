...
> **关联文档**: [65. 历史自进化模拟壳（已退役）](./65-self-evolving-ai.md) · [16. AI技能系统](./16-ai-skills.md) · [76. 技能创建系统](./76-skill-creator.md)
...
见正文「模块概述 / 功能描述」。自主学习闭环系统（Autonomous Learning Loop v1.0）：自主学习闭环。
