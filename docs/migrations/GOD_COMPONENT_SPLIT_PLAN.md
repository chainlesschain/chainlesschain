...
> 日期：2026-04-22
> 对应审计：[`../audits/AUDIT_2026-04-22.md`](../audits/AUDIT_2026-04-22.md) §1 超大文件
...
docs/audits/AUDIT_2026-04-22.md 这一轮（commit 6e58ad93c..4ede1f418）聚焦**低风险、广覆盖**的修复：IPC 测试空白、XSS、依赖风险披露、helper 抽取、CI、文档。单次会话拆 21k 行代码违反小步提交原则，会让回归排查失控。
