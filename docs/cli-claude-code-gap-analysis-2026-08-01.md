...
| P0 exact-SHA 发布门禁与原生发行链                  | 门禁已实现，发布阻断             | `6d229d0df4`、`55b3c55a1c`：三平台 exact-SHA gate、不可变 npm tarball、六目标签名 manifest、完整同版本身份校验、versioned asset 禁止覆盖和 stable channel 激活协议；发布契约 28 项通过。没有待发布精确提交上的完整 `CLI CI` + `CLI Strict Sandbox` 权威矩阵，不得发布                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| P0 签名更新与回滚链                                | 基础已实现，事务加固中           | `4d3a4ee788` 提供签名 manifest、健康检查与初版自动回滚；后续事务审计仍发现 installer/OTA 锁互斥、backup lineage、Windows sidecar/alias、结果消费及 rescue rollback 等阻断，修复与真实安装/升级/回滚矩阵完成前不得标记为 release-ready                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
