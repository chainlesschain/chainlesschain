...
> 分析起始日期：2026-08-01；当前核验日期：2026-08-17
>
> ChainlessChain 历史候选基线：`packages/cli` v0.162.194 release candidate；v0.162.190 / v0.162.191 / v0.162.192 未发布；v0.162.193 已被非权威通用 workflow 发布且不得视为门禁通过。当前 CLI 发布核验基线为最终 release SHA `1a10ed7c8fd14d12f7760e948ff8efe36c766602`（2026-08-17，PR #214），不可变 tag 为 `v-npm-0-165-1`；公网 npm `latest` 为 v0.165.1。v0.165.1 的 exact-SHA 发布子闭环已完成；当前收口和未完成项见第 18.28 节，v0.163.8 的历史发布证据保留在第 18.12 节。
>
