...
因此当前可以提交仓库实现并让最终合并 SHA 进入 CLI/IDE 正式矩阵；只有该 SHA 的权威门全绿后才创建 `v-npm-0-166-12`、`ide-vscode-v0.37.74` 与 `ide-jetbrains-v0.4.105`。即使 CLI/IDE 发布成功，P1-10、P1-11、P1-12、P2-3 及 P1-3 production close 仍必须保持部分完成，直到上述外部 producer/凭据/预算/真实流量证据实际通过。
