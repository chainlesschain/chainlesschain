...
以上远端成功只证明各自精确 head 的对应 job；提交 `5f078f8185` 及其后继审计文档仍必须以 PR 当前 head 的 GitHub Actions 结果为准。即使最终矩阵全绿并合入 `main`，P1-3、P1-10、P1-11、P1-12 仍各自缺少 §12.72 列出的受保护 main 外部证据，因此状态和 16/6/4/0 汇总不变。
