...
| P1     | P1-3  | canonical Agent Kernel 与 rollout      | 🟡 部分完成 | 真实 CLI loop、rollout hash chain/SQLite/checkpoint/compact/resume/fork 与 terminal evidence 已发布                                                                                                                                                                                                     | Desktop `$team`、旧 runtime 和全部执行入口切到唯一内核；详见 §6.9.6.7，完整五 surface 估算 32～50 人日                                                                    |
...
| P1     | P1-12 | Graph Kernel 集成、双写验证与迁移切换  | ⏳ 待完成   | machine-readable claims、single-writer/shadow/cutover gate 已具备；Browser 标明 non-durable                                                                                                                                                                                                             | 五 surface 分别完成 shadow/canary/default/read-only、回滚演练及旧 writer/旧 shell 下线；关闭条件见 §6.9.6.7.4                                                             |
