...
// 初始化技能管理器
const result = skillmanager.catch(/* error */);

// 注册技能
const result = skillmanager.if(/* !skillData.name */);

// 注册技能
const result = skillmanager.if(/* !skillData.category */);

```

---

> 自动生成时间: 2026/4/19 17:59:27
