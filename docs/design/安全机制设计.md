...
详细文档见 [文档站 SIMKey 页面](https://docs.chainlesschain.com/chainlesschain/simkey)
...
详细设计见 [21\_统一密钥系统.md](modules/21_统一密钥系统.md) 第十一章
...
详细设计见 [24\_数据防泄漏系统.md](modules/24_数据防泄漏系统.md)
...
详细设计见 [21\_统一密钥系统.md](modules/21_统一密钥系统.md) 第十三章
...
### 1. 概述
见正文头部。安全机制设计：U盾/SIMKey + SQLCipher + 加密架构。

### 2. 核心特性
U-Key/SIMKey / SQLCipher / 多层加密 / DID。

### 3. 系统架构
见正文架构 / 设计章节。

### 4. 系统定位
ChainlessChain 的「安全机制设计」。
