...
| **SSO企业认证** ⭐  | [14\_SSO企业认证.md](modules/14_SSO企业认证.md)   | **v0.34.0新增**,SAML/OAuth/OIDC       |
| **MCP SDK** ⭐      | [15\_MCP_SDK系统.md](modules/15_MCP_SDK系统.md)   | **v0.34.0新增**,Server Builder,社区   |
