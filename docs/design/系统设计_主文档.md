...
> 历史增量：2026-09-13，源码 `a1db1f98aa`、公开 CLI `0.166.46`。请先阅读 [Agent 运行时增量设计](agent-runtime-update-2026-09-13.md)，涵盖普通聊天修复、模型能力与 Responses、延后回答、中文记忆召回、沙箱能力报告和发布证据。下方 v3.3 元数据保留为历史架构基线。
