...
## 系统设计文档 v2.25 (更新至 v0.32.0 实际实现状态)

**文档版本**: 2.25
**系统版本**: v0.32.0 (生产就绪,全平台功能完善,iOS/Android大规模功能增强)
**最后更新**: 2026-02-10
...
- **560+个** 主进程文件 (JS/TS混合，组织在78个分类目录中)
- **247,000+行** 代码 (包含iOS/Android新模块)
- **245个** Vue组件 (23个页面 + 222个业务组件)
- **28个** TypeScript Stores (完整迁移，v0.29.0)
- **17个** 数据库迁移文件 (3,300行SQL)
- **300+** 工具函数, **115+** 技能模块
- **~247,000行** 核心代码 (+12,000行 v0.32.0新增)
- **85,000+字** 技术文档
