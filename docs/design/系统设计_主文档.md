...
## 系统设计文档 v2.27 (更新至 v0.34.0 实际实现状态)

**文档版本**: 2.27
**系统版本**: v0.34.0 (生产就绪,企业审计+插件市场+多代理+SSO+MCP SDK)
**最后更新**: 2026-02-15
...
| SSO企业认证 ⭐  | [14\_SSO企业认证.md](modules/14_SSO企业认证.md)   | **v0.34.0新增**,SAML/OAuth/OIDC,身份关联  |
| MCP SDK ⭐      | [15\_MCP_SDK系统.md](modules/15_MCP_SDK系统.md)   | **v0.34.0新增**,Server Builder,社区注册   |
