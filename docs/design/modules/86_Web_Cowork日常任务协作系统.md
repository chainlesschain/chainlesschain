...
> **完整设计**: 见 [87-cowork-evolution-n1-n7.md](./87_Cowork_Evolution_N1_N7.md)（含每个 N 项的文件级变更表、测试计划、风险与 ADR）。
...
### 1. 概述
见正文「模块概述 / 功能描述」。Web Cowork 日常任务协作系统（web-cowork）：Web 端多智能体协作。

### 2. 核心特性
Web Cowork / 任务协作 / 多 Agent。

### 3. 系统架构
见正文「架构设计」。

### 4. 系统定位
ChainlessChain 的「Web Cowork 日常任务协作系统」。
