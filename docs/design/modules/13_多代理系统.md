...
- [Cowork多代理协作](https://github.com/chainlesschain/chainlesschain/blob/main/docs/features/COWORK_FINAL_SUMMARY.md)
- [Cowork快速开始](https://github.com/chainlesschain/chainlesschain/blob/main/docs/features/COWORK_QUICK_START.md)
- [Skills系统](https://github.com/chainlesschain/chainlesschain/blob/main/docs/features/COWORK_FINAL_SUMMARY.md)
- [企业审计系统](11_企业审计系统.md)
...
### 1. 概述
见正文「模块概述 / 功能描述」。多代理系统（Cowork）：多智能体协作 / 任务分配 / 并行执行。

### 2. 核心特性
TeammateTool / Agent Pool / FileSandbox / 投票决策 / 检查点。

### 3. 系统架构
见正文「架构设计」。

### 4. 系统定位
ChainlessChain 的「多代理协作系统（Cowork）」。

### 5. 核心功能
见正文模块概述与各节。

### 6. 技术架构
见正文实现章节；ai-engine/cowork 模块。
