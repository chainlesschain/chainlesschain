...
**文档**：
- `docs-site/docs/chainlesschain/coding-workflow.md` (用户文档，含 Phase 3.5 + Phase 4 + Phase 5 全量示例)
- `docs/design/modules/80_规范工作流系统.md` (本文件)

**测试总数**：25 + 13 + 4 + 5 + 3 + 16 + 4 + 9 + 6 + 7 + 2 = **94 tests**，全部通过（其中 Phase 5 的 2 个为真 spawn 集成）。
