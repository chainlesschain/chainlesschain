...
>
> **状态**: 全部五阶段实施完成,共 215+ 单元/集成/E2E 测试绿。详见 [`LIGHTWEIGHT_MULTI_AGENT_ORCHESTRATION_ADR.md`](https://github.com/chainlesschain/chainlesschain/blob/main/docs/implementation-plans/LIGHTWEIGHT_MULTI_AGENT_ORCHESTRATION_ADR.md)。
...
**维护者**: 开发团队
**相关文档**: [coding-workflow.md](https://docs.chainlesschain.com/chainlesschain/coding-workflow), [79_Coding_Agent系统.md](./79_Coding_Agent系统.md)
...
### 1. 概述
见正文「模块概述 / 功能描述」。规范工作流系统（Canonical Coding Workflow）：标准化编码工作流。
