...
AI 技能系统提供 **141 个桌面内置技能 (100% Handler 覆盖)** + **28 个 Android 技能**、统一工具注册表、10 个演示模板以及 Agent Skills 开放标准支持。通过统一注册表聚合 FunctionCaller (60+ 工具)、MCP (8 服务器) 和 Skills (141 技能) 三大工具系统，为 AI 提供结构化的技能感知能力。
...
所有 141 个技能均配备可执行 Handler，按功能分为 18+ 大类别：
...
- Skills (141 技能) → UnifiedToolRegistry
...
### 2. 核心特性
144 内置技能 / SKILL.md / 懒加载 / 门控检查 / 热加载卸载。
