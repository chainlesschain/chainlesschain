...
AI 技能系统提供 **118 个桌面内置技能 (100% Handler 覆盖)** + **28 个 Android 技能**、统一工具注册表、10 个演示模板以及 Agent Skills 开放标准支持。通过统一注册表聚合 FunctionCaller (60+ 工具)、MCP (8 服务器) 和 Skills (118 技能) 三大工具系统，为 AI 提供结构化的技能感知能力。

### 核心特性

- **118 个桌面内置技能**: 全部配备可执行 handler，100% Handler 覆盖率，覆盖 18+ 大类别
...
## 2. 118 个桌面内置技能 (100% Handler 覆盖)

### 2.1 技能分类总览

所有 118 个技能均配备可执行 Handler，按功能分为 18+ 大类别：

| 类别         | 技能数 | 技能名                                                                                                                                                                                                                                                    |
| ------------ | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **自动化**   | 6      | browser-automation, computer-use, workflow-automation, voice-commander, proactive-agent, cron-scheduler                                                                                                                                                   |
| **搜索**     | 2      | tavily-search, find-skills                                                                                                                                                                                                                                |
| **数据**     | 4      | web-scraping, data-analysis, chart-creator, csv-processor                                                                                                                                                                                                 |
| **知识**     | 9      | memory-management, smart-search, context-loader, research-agent, codebase-qa, deep-research, ultrathink, news-monitor, youtube-summarizer                                                                                                                 |
| **远程**     | 1      | remote-control                                                                                                                                                                                                                                            |
...
| **开发**     | 16     | code-review, git-commit, explain-code, repo-map, refactor, onboard-project, lint-and-fix, project-scaffold, mcp-server-generator, architect-mode, commit-splitter, screenshot-to-code, diff-previewer, task-decomposer, code-runner, git-worktree-manager |
...
AI Skills System (v1.2.0)
    ├── 118 桌面内置技能 (100% Handler 覆盖, 扩展自 3→8→15→30→90→96→118)
