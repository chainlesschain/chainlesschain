...
- [Computer Use 功能指南](https://github.com/chainlesschain/chainlesschain/blob/main/desktop-app-vue/docs/features/COMPUTER_USE_GUIDE.md)
...
### 1. 概述
见正文「模块概述 / 功能描述」。远程控制系统：跨设备远程操控（桌面 ↔ 移动）。

### 2. 核心特性
远程命令 / signaling / WebRTC / 配对信任。

### 3. 系统架构
见正文「架构设计」。

### 4. 系统定位
ChainlessChain 的「远程控制系统」。

### 5. 核心功能
见正文模块概述与各节。

### 6. 技术架构
见正文实现章节；remote 模块 / signaling。
