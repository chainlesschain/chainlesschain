...
| 指标                       | 拆分前 | 拆分后 |     变化 |
| -------------------------- | -----: | -----: | -------: |
| `ipc-registry.js` 行数     |   4925 |   1595 |   −3330 |
| 顶层 Phase 注册块          |     77 |      1 |    −76 |
| `phases/` 目录文件数       |      0 |     11 |    +11 |
| 总代码行数（含 phases）   |   4925 |   5293 |    +368 |
...
| 测试文件                                          | 测试数量 | 状态        |
| ------------------------------------------------- | -------: | ----------- |
| `src/main/ipc/__tests__/phase-modules.test.js`    |   **33** | ✅ 通过     |
