...
| 指标                       | 拆分前 | 拆分后 |     变化 |
| -------------------------- | -----: | -----: | -------: |
| `ipc-registry.js` 行数     |   4925 |    899 |   −4026 |
| 顶层 Phase 注册块          |     84 |      0 |    −84 |
| `phases/` 目录文件数       |      0 |     14 |    +14 |
| 总代码行数（含 phases）   |   4925 |   5431 |    +506 |
...
| 测试文件                                          | 测试数量 | 状态        |
| ------------------------------------------------- | -------: | ----------- |
| `src/main/ipc/__tests__/phase-modules.test.js`    |   **42** | ✅ 通过     |
