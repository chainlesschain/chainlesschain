...
| 指标                       | 拆分前 | 拆分后 |     变化 |
| -------------------------- | -----: | -----: | -------: |
| `ipc-registry.js` 行数     |   4925 |   1704 |   −3221 |
| 顶层 Phase 注册块          |     77 |      2 |    −75 |
| `phases/` 目录文件数       |      0 |     10 |    +10 |
| 总代码行数（含 phases）   |   4925 |   5232 |    +307 |
...
| 测试文件                                          | 测试数量 | 状态        |
| ------------------------------------------------- | -------: | ----------- |
| `src/main/ipc/__tests__/phase-modules.test.js`    |   **30** | ✅ 通过     |
