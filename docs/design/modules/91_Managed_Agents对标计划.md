...
### 1. 概述
见正文「模块概述 / 功能描述」。Managed Agents 对标计划：对标 managed agents 能力（headless/cost/checkpoint 等）。

### 2. 核心特性
Managed Agents 平价 / headless / cost / checkpoint。

### 3. 系统架构
见正文「架构设计」。

### 4. 系统定位
ChainlessChain 的「Managed Agents 对标计划」。
