...
- [Computer Use 用户指南](https://github.com/chainlesschain/chainlesschain/blob/main/desktop-app-vue/docs/features/COMPUTER_USE_GUIDE.md)
...
### 1. 概述
见正文「模块概述 / 功能描述」。浏览器自动化系统：Playwright/CDP 驱动的浏览器自动化（v0.33.0 已完成）。
...
### 4. 系统定位
ChainlessChain 的「浏览器自动化系统」。

### 5. 核心功能
见正文模块概述与各节。

### 6. 技术架构
见正文实现章节；browser-automation 模块。
