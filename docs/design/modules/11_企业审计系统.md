...
- [IPC错误处理指南](https://github.com/chainlesschain/chainlesschain/blob/main/docs/guides/IPC_ERROR_HANDLER_GUIDE.md)
...
### 1. 概述
见正文「模块概述 / 功能描述」。企业审计与合规管理系统：操作审计 + 合规管理。
