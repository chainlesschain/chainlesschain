...
│   │   └── agent-repl.js          # Agentic REPL (8 工具 + 146 技能)
│   ├── runtime/                   # 无头运行时
...
│       ├── llm-providers.js       # 8 内置 LLM Provider 注册 (Phase 3)
│       ├── task-model-selector.js # 任务智能模型选择器 (6 任务类型 × 8 Provider)
...
| 层 | 优先级 | 路径 | 用途 |
|---|--------|------|------|
| bundled | 0 (最低) | `desktop-app-vue/.../skills/builtin/` | 146 内置技能 |
...
### 1. 概述
见正文「模块概述 / 功能描述」。CLI 分发系统：CLI 打包与多渠道分发。
