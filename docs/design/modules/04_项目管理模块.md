...
见正文「2.4.1 功能描述」。项目管理模块是系统最核心、对用户最有直接价值的模块：把 AI 能力转化为生产力，用户用自然语言下达指令，AI 完成文件处理与创作，项目文件统一管理。

### 2. 核心特性

对话式工作流（自然语言下达需求）；全能文件处理（网页 / 文档 / 数据 / 演示 / 视频）；AI 辅助创作；项目文件统一管理。
...
ChainlessChain 的**核心生产力模块**（AI 辅助工作流）。

### 5. 核心功能

见正文：对话式工作流 / 多类型文件处理 / AI 创作 / 项目管理。

### 6. 技术架构

自然语言 → AI 工具调用 → 文件处理 / 创作；项目文件统一存储。

### 7. 系统特点

对话优先（无需掌握复杂软件）；几乎所有常见文件类型。

### 8. 应用场景

写作 / 文档 / 数据 / 演示 / 视频等 AI 辅助创作工作流。

### 9. 竞品对比

对话式 AI 工作流 vs 传统软件操作。

### 10. 配置参考

LLM provider / model；文件处理工具配置。
...
工具调用失败 / 文件处理异常 → 检查 LLM 与工具配置。

### 15. 关键文件

`desktop-app-vue/src/main/`（项目 / 文件处理 / AI 工作流）。
