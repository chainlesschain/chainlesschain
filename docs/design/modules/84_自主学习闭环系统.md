...
> **关联文档**：[65. 历史自进化模拟壳（已退役）](./65_自进化AI系统.md) · [112. 受治理 Skill 自进化](./112-governed-skill-evolution-design.md) · [Agent 自进化差距分析](../../research/agents/AGENT_SELF_EVOLUTION_GAP_ANALYSIS_2026-09-01.md)
