...
- **技能工具**: 300+ 工具, 30个内置技能 (Agent Skills标准)
- **统一工具注册表**: FunctionCaller(60+) + MCP(8) + Skills(30) 三系统聚合
- npm依赖: 140+ 个包
- 总代码行数: ~280,000行
...
| Skills系统          | 100%   | 完成 ✅ | 30内置技能, 四层加载, Agent Skills标准 ⭐v0.36.0 |
...
- 已实现功能: 30内置技能, 统一工具注册表(60+工具+8 MCP+30技能), 10演示模板
