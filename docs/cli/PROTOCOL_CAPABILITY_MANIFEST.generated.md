...
| `permission_decision` | 1 | `permission_decision, permission_decision_id` | gated tool_result lines may carry a redacted permission decision and its correlation id |
