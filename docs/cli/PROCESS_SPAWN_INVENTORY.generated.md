...
| `packages/cli/src/lib/plugin-monitor-supervisor.js` | 30 | `spawn: (...args) => executionBroker.spawn(...args),` |
| `packages/cli/src/lib/plugin-monitor-supervisor.js` | 43 | `this._spawn = opts.spawn \|\| _deps.spawn;` |
