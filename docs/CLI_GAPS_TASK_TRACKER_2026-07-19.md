...
| P1-9  | Plugin 安全强化      | 🟡 OS secret + Broker provenance 已补 | 签名/manifest SHA-256、trusted key、安装后 SBOM 文件摘要、capability consent、managed allow/deny、DPAPI/Keychain/Secret Service、插件 MCP/LSP/Hook/Monitor/Bin Broker provenance 与 Desktop 主进程 child_process/node-pty Broker 已有；原生模块和外部宿主全路径仍待补 |
