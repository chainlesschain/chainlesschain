...
| ------------------------ | ---------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0-S / S0-1～S0-3        | 六类仓库级安全/正确性闭包已拆分提交并通过定向验证；release gate 尚未全局关闭 | `70306bd8ee` 提交 structured semantic handoff（37 项测试）；`ece470137d` 提交 Plan/TODO persistence（155 项测试）；`7c97c11ebd` 提交 Skill/MCP safety controls（48 项测试）；`199b2cb7c6` 提交 WS recovery state（201 项测试）；`9332a21ab3` 提交子树 mutation preflight（27 项测试）；`6be06f4448` 提交 Plan hard ceiling、capability fence、contract/permission/Hook fail-closed 与 subagent authority inheritance（关键定向集 36/36 通过）；`46688dd9ca` 补齐 owner-only `secure-fs` 运行时依赖                            | 仍需在 exact release commit 上完成 Linux/Windows/macOS、strict sandbox、重启/恢复与安全矩阵；真实矩阵完成前不把仓库级实现宣称为发布验收，也不扩大 Auto/无人值守保证                                                                                                   |
