#!/usr/bin/env bash
# Atomic swap deploy for v5.0.3.121 — docs / design / www.
...
deploy_one docs.chainlesschain.com   /tmp/deploy-docs-v121.tar.gz   500
deploy_one design.chainlesschain.com /tmp/deploy-design-v121.tar.gz 240
deploy_one www.chainlesschain.com    /tmp/deploy-www-v121.tar.gz    18
echo "=== DONE ==="
