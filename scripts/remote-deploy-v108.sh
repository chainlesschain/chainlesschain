#!/usr/bin/env bash
# Atomic swap deploy for v5.0.3.108 — docs / design / www.
# Uploaded to /tmp and run via ssh/plink. Per-site: extract to .new, verify html
...
deploy_one docs.chainlesschain.com   /tmp/deploy-docs-v108.tar.gz   500
deploy_one design.chainlesschain.com /tmp/deploy-design-v108.tar.gz 240
deploy_one www.chainlesschain.com    /tmp/deploy-www-v108.tar.gz    18
echo "=== DONE ==="
