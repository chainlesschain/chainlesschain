#!/usr/bin/env bash
# Atomic swap deploy for v5.0.3.117 — docs / design / www.
...
deploy_one docs.chainlesschain.com   /tmp/deploy-docs-v117.tar.gz   500
deploy_one design.chainlesschain.com /tmp/deploy-design-v117.tar.gz 240
deploy_one www.chainlesschain.com    /tmp/deploy-www-v117.tar.gz    18
echo "=== DONE ==="
