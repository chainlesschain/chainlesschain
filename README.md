...
## ⭐ 当前版本: v0.22.0 (2026-01-13)

### 最新更新
- ✅ **移动端社交功能完成** - WebSocket实时更新、群聊功能(创建/管理/消息)、@提及好友、#话题标签、动态分享(好友/链接/图片)、完整社交体验 ⭐最新
...
- 🟢 **移动端应用**: 100% 完成 - **知识库+AI聊天+交易系统(100%)+社交功能(100%)+语音输入/输出+QR码扫描+综合设置(勿扰模式/声音振动)+实时通知系统(推送/通知中心/角标)+移动端UX优化+Git同步** ⭐完成
