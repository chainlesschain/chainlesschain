...
|------|------|------|----------|--------|-------------|
| **v0.31.0** | 🔵 待开始 | 0% | 0/14 | 14 | 2026-02-15 |
...
- [ ] **Task 1.1.1**: 添加ZXing依赖到build.gradle.kts
- [ ] **Task 1.1.2**: 创建QRCodeGenerator.kt (120行)
  - `generateQRCode()` - 基础二维码生成
  - `generateDIDQRCode()` - DID二维码（含签名）
  - 支持自定义颜色和Logo
- [ ] **Task 1.1.3**: 创建MyQRCodeScreen.kt (180行)
  - 个人信息展示（头像、昵称、DID）
  - 二维码展示
  - 保存到相册功能
  - 分享功能
- [ ] **Task 1.1.4**: 创建MyQRCodeViewModel.kt (100行)
  - 生成签名二维码
  - 保存到相册
  - 分享二维码
- [ ] **Task 1.1.5**: 更新NavGraph添加MyQRCode路由
