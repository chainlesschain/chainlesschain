...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        maven { url = uri("https://maven.aliyun.com/repository/google") }
        val aliyunPublic = maven { url = uri("https://maven.aliyun.com/repository/public") }
        ...
        // 失败 (CI runs 27349353057 / 27374396657, 2026-06-11/12 连续数
        // 小时)。exclusiveContent 把该 group 限定到 [Central, aliyun
        // public] — Central 对老版本干净 404 后落到 public, 不再咨询
        // 502 频发的 aliyun/google。长期解法是升级/替换 BIP39 依赖。
        exclusiveContent {
            forRepositories(central, aliyunPublic)
